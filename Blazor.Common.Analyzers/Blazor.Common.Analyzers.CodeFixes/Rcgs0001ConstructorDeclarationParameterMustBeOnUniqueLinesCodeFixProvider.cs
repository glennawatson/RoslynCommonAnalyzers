...
[Shared]
public sealed class Rcgs0001ConstructorDeclarationParameterMustBeOnUniqueLinesCodeFixProvider : CodeFixProvider
{
    /// <inheritdoc/>
    public override ImmutableArray<string> FixableDiagnosticIds => [Rcgs0001ConstructorDeclarationParameterMustBeOnUniqueLinesAnalyzer.DiagnosticId];
