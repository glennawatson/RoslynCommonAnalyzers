...
[Shared]
public sealed class Rcgs0003DelegateDeclarationParameterMustBeOnUniqueLinesCodeFixProvider : CodeFixProvider
{
    /// <inheritdoc/>
    public override ImmutableArray<string> FixableDiagnosticIds => [Rcgs0003DelegateDeclarationParameterMustBeOnUniqueLinesAnalyzer.DiagnosticId];
