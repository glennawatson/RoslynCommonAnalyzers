...
/// <summary>
/// A code fix provider for the <see cref="Rcgs0011RecordDeclarationParameterMustBeOnUniqueLinesAnalyzer"/> analyzer.
/// </summary>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Rcgs0011RecordDeclarationParameterMustBeOnUniqueLinesCodeFixProvider))]
[Shared]
public sealed class Rcgs0011RecordDeclarationParameterMustBeOnUniqueLinesCodeFixProvider : CodeFixProvider
{
    /// <inheritdoc/>
    public override ImmutableArray<string> FixableDiagnosticIds => [Rcgs0011RecordDeclarationParameterMustBeOnUniqueLinesAnalyzer.DiagnosticId];
            ...
            if (node is RecordDeclarationSyntax syntaxNode)
            {
                ...
                context.RegisterCodeFix(
                    CodeAction.Create(
                        ...
                        nameof(Rcgs0011RecordDeclarationParameterMustBeOnUniqueLinesCodeFixProvider) + "-Add"),
                    diagnostic);
                return;
            }
        }
