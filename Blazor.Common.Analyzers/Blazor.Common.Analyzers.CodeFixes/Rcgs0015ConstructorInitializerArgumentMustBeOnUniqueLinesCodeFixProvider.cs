...
/// <summary>
/// A code fix provider for the <see cref="Rcgs0015ConstructorInitializerArgumentMustBeOnUniqueLinesAnalyzer"/> analyzer.
/// </summary>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Rcgs0015ConstructorInitializerArgumentMustBeOnUniqueLinesCodeFixProvider))]
[Shared]
public sealed class Rcgs0015ConstructorInitializerArgumentMustBeOnUniqueLinesCodeFixProvider : CodeFixProvider
{
    /// <inheritdoc/>
    public override ImmutableArray<string> FixableDiagnosticIds => [Rcgs0015ConstructorInitializerArgumentMustBeOnUniqueLinesAnalyzer.DiagnosticId];
            ...
            if (node is ConstructorInitializerSyntax syntaxNode)
            {
                ...
                context.RegisterCodeFix(
                    CodeAction.Create(
                        ...
                        nameof(Rcgs0015ConstructorInitializerArgumentMustBeOnUniqueLinesCodeFixProvider) + "-Add"),
                    diagnostic);
                return;
            }
        }
