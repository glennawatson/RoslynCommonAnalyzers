...
/// <summary>
/// A code fix provider for the <see cref="Rcgs0017LocalFunctionStatementParameterMustBeOnUniqueLinesAnalyzer"/> analyzer.
/// </summary>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Rcgs0017LocalFunctionStatementParameterMustBeOnUniqueLinesCodeFixProvider))]
[Shared]
public sealed class Rcgs0017LocalFunctionStatementParameterMustBeOnUniqueLinesCodeFixProvider : CodeFixProvider
{
    /// <inheritdoc/>
    public override ImmutableArray<string> FixableDiagnosticIds => [Rcgs0017LocalFunctionStatementParameterMustBeOnUniqueLinesAnalyzer.DiagnosticId];
            ...
            if (node is LocalFunctionStatementSyntax syntaxNode)
            {
                ...
                context.RegisterCodeFix(
                    CodeAction.Create(
                        ...
                        nameof(Rcgs0017LocalFunctionStatementParameterMustBeOnUniqueLinesCodeFixProvider) + "-Add"),
                    diagnostic);
                return;
            }
        }
    ...
    private static Task<Document> FixAsync(Document document, SyntaxNode root, LocalFunctionStatementSyntax node)
    {
