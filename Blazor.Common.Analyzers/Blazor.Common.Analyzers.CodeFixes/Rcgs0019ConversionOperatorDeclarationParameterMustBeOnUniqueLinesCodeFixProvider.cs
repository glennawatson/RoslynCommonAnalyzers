...
/// <summary>
/// A code fix provider for the <see cref="Rcgs0019ConversionOperatorDeclarationParameterMustBeOnUniqueLinesAnalyzer"/> analyzer.
/// </summary>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Rcgs0019ConversionOperatorDeclarationParameterMustBeOnUniqueLinesCodeFixProvider))]
[Shared]
public sealed class Rcgs0019ConversionOperatorDeclarationParameterMustBeOnUniqueLinesCodeFixProvider : CodeFixProvider
{
    /// <inheritdoc/>
    public override ImmutableArray<string> FixableDiagnosticIds => [Rcgs0019ConversionOperatorDeclarationParameterMustBeOnUniqueLinesAnalyzer.DiagnosticId];
            ...
            if (node is ConversionOperatorDeclarationSyntax syntaxNode)
            {
                ...
                context.RegisterCodeFix(
                    CodeAction.Create(
                        ...
                        nameof(Rcgs0019ConversionOperatorDeclarationParameterMustBeOnUniqueLinesCodeFixProvider) + "-Add"),
                    diagnostic);
                return;
            }
        }
