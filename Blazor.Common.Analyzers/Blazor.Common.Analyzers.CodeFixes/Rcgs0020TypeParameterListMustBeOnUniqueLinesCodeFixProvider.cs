...
/// <summary>
/// A code fix provider for the <see cref="Rcgs0020TypeParameterListMustBeOnUniqueLinesAnalyzer"/> analyzer.
/// </summary>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Rcgs0020TypeParameterListMustBeOnUniqueLinesCodeFixProvider))]
[Shared]
public sealed class Rcgs0020TypeParameterListMustBeOnUniqueLinesCodeFixProvider : CodeFixProvider
{
    /// <inheritdoc/>
    public override ImmutableArray<string> FixableDiagnosticIds => [Rcgs0020TypeParameterListMustBeOnUniqueLinesAnalyzer.DiagnosticId];
            ...
            if (node is TypeParameterListSyntax syntaxNode)
            {
                ...
                context.RegisterCodeFix(
                    CodeAction.Create(
                        ...
                        nameof(Rcgs0020TypeParameterListMustBeOnUniqueLinesCodeFixProvider) + "-Add"),
                    diagnostic);
                return;
            }
        }
