...
using Verifyrcgs0006 = Blazor.Common.Analyzers.Tests.CSharpCodeFixVerifier<
    Blazor.Common.Analyzers.Rcgs0006ObjectCreationExpressionArgumentMustBeOnUniqueLinesAnalyzer,
    Blazor.Common.Analyzers.Rcgs0006ObjectCreationExpressionArgumentMustBeOnUniqueLinesCodeFixProvider>;

namespace Blazor.Common.Analyzers.Tests;

/// <summary>Unit tests for the RCGS0006 analyzer that requires object-creation expressions to keep their parameters on unique lines.</summary>
