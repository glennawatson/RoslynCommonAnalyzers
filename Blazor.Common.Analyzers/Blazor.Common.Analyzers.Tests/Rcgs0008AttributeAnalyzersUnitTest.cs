...
using Verifyrcgs0008 = Blazor.Common.Analyzers.Tests.CSharpCodeFixVerifier<
    Blazor.Common.Analyzers.Rcgs0008AttributeArgumentMustBeOnUniqueLinesAnalyzer,
    Blazor.Common.Analyzers.Rcgs0008AttributeArgumentMustBeOnUniqueLinesCodeFixProvider>;

namespace Blazor.Common.Analyzers.Tests;

/// <summary>Unit tests for the RCGS0008 analyzer that requires attribute argument lists to keep their parameters on unique lines.</summary>
