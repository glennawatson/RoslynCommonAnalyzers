...
using Verifyrcgs0009 = Blazor.Common.Analyzers.Tests.CSharpCodeFixVerifier<
    Blazor.Common.Analyzers.Rcgs0009AnonymousMethodExpressionParameterMustBeOnUniqueLinesAnalyzer,
    Blazor.Common.Analyzers.Rcgs0009AnonymousMethodExpressionParameterMustBeOnUniqueLinesCodeFixProvider>;

namespace Blazor.Common.Analyzers.Tests;

/// <summary>Unit tests for the RCGS0009 analyzer that requires anonymous method expressions to keep their parameters on unique lines.</summary>
