...
using Verifyrcgs0010 = Blazor.Common.Analyzers.Tests.CSharpCodeFixVerifier<
    Blazor.Common.Analyzers.Rcgs0010ParenthesizedLambdaExpressionParameterMustBeOnUniqueLinesAnalyzer,
    Blazor.Common.Analyzers.Rcgs0010ParenthesizedLambdaExpressionParameterMustBeOnUniqueLinesCodeFixProvider>;

namespace Blazor.Common.Analyzers.Tests;

/// <summary>Unit tests for the RCGS0010 analyzer that requires parenthesized lambda expressions to keep their parameters on unique lines.</summary>
