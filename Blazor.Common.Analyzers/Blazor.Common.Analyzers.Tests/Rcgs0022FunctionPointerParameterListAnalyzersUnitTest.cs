...
using Verifyrcgs0022 = Blazor.Common.Analyzers.Tests.CSharpCodeFixVerifier<
    Blazor.Common.Analyzers.Rcgs0022FunctionPointerParameterListMustBeOnUniqueLinesAnalyzer,
    Blazor.Common.Analyzers.Rcgs0022FunctionPointerParameterListMustBeOnUniqueLinesCodeFixProvider>;

namespace Blazor.Common.Analyzers.Tests;

/// <summary>Unit tests for the RCGS0022 analyzer that requires function pointer parameter lists to be on unique lines.</summary>
public class Rcgs0022FunctionPointerParameterListAnalyzersUnitTest
{
    ...
    {
        var test = new Verifyrcgs0022.Test
        {
            TestCode = source,
        };
