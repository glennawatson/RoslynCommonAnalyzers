...
public sealed class Rcgs0004IndexerDeclarationParameterMustBeOnUniqueLinesAnalyzer : DiagnosticAnalyzer
{
    /// <summary>The unique diagnostic identifier for this analyzer.</summary>
    internal const string DiagnosticId = "RCGS0004";
    ...
    {
        if (context.Node is not IndexerDeclarationSyntax node)
        {
            return;
        }
