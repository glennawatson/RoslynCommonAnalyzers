...
public sealed class Rcgs0007ElementAccessExpressionArgumentMustBeOnUniqueLinesAnalyzer : DiagnosticAnalyzer
{
    /// <summary>The unique diagnostic identifier for this analyzer.</summary>
    internal const string DiagnosticId = "RCGS0007";
    ...
    {
        if (context.Node is not ElementAccessExpressionSyntax node)
        {
            return;
        }
