...
public sealed class Rcgs0009AnonymousMethodExpressionParameterMustBeOnUniqueLinesAnalyzer : DiagnosticAnalyzer
{
    /// <summary>The unique diagnostic identifier for this analyzer.</summary>
    internal const string DiagnosticId = "RCGS0009";
    ...
    {
        if (context.Node is not AnonymousMethodExpressionSyntax node)
        {
            return;
        }
