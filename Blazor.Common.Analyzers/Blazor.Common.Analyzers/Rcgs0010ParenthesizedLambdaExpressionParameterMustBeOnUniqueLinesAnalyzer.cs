...
public sealed class Rcgs0010ParenthesizedLambdaExpressionParameterMustBeOnUniqueLinesAnalyzer : DiagnosticAnalyzer
{
    /// <summary>The unique diagnostic identifier for this analyzer.</summary>
    internal const string DiagnosticId = "RCGS0010";
    ...
    {
        if (context.Node is not ParenthesizedLambdaExpressionSyntax node)
        {
            return;
        }
