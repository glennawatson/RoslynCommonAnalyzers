...
public sealed class Rcgs0011RecordDeclarationParameterMustBeOnUniqueLinesAnalyzer : DiagnosticAnalyzer
{
    /// <summary>The unique diagnostic identifier for this analyzer.</summary>
    internal const string DiagnosticId = "RCGS0011";
    ...
    {
        if (context.Node is not RecordDeclarationSyntax node)
        {
            return;
        }
