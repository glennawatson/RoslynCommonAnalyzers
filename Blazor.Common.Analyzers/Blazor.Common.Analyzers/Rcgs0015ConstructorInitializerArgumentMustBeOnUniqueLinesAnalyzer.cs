...
public sealed class Rcgs0015ConstructorInitializerArgumentMustBeOnUniqueLinesAnalyzer : DiagnosticAnalyzer
{
    /// <summary>The unique diagnostic identifier for this analyzer.</summary>
    internal const string DiagnosticId = "RCGS0015";
    ...
    {
        if (context.Node is not ConstructorInitializerSyntax node)
        {
            return;
        }
