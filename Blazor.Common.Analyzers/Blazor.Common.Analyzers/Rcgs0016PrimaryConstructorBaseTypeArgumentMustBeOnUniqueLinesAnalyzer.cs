...
public sealed class Rcgs0016PrimaryConstructorBaseTypeArgumentMustBeOnUniqueLinesAnalyzer : DiagnosticAnalyzer
{
    /// <summary>The unique diagnostic identifier for this analyzer.</summary>
    internal const string DiagnosticId = "RCGS0016";
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        context.RegisterSyntaxNodeAction(Analyze, SyntaxKind.PrimaryConstructorBaseType);
    }
    ...
    {
        if (context.Node is not PrimaryConstructorBaseTypeSyntax node)
        {
            return;
        }
