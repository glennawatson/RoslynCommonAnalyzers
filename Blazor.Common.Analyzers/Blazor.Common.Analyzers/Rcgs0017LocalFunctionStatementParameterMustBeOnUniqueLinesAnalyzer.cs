...
public sealed class Rcgs0017LocalFunctionStatementParameterMustBeOnUniqueLinesAnalyzer : DiagnosticAnalyzer
{
    /// <summary>The unique diagnostic identifier for this analyzer.</summary>
    internal const string DiagnosticId = "RCGS0017";
    ...
    {
        if (context.Node is not LocalFunctionStatementSyntax node)
        {
            return;
        }
