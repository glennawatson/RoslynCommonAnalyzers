...
public sealed class Rcgs0018OperatorDeclarationParameterMustBeOnUniqueLinesAnalyzer : DiagnosticAnalyzer
{
    /// <summary>The unique diagnostic identifier for this analyzer.</summary>
    internal const string DiagnosticId = "RCGS0018";
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        context.RegisterSyntaxNodeAction(Analyze, SyntaxKind.OperatorDeclaration);
    }
    ...
    {
        if (context.Node is not OperatorDeclarationSyntax node)
        {
            return;
        }
