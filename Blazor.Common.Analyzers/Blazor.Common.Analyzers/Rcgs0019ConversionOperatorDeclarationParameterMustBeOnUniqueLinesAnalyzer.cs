...
public sealed class Rcgs0019ConversionOperatorDeclarationParameterMustBeOnUniqueLinesAnalyzer : DiagnosticAnalyzer
{
    /// <summary>The unique diagnostic identifier for this analyzer.</summary>
    internal const string DiagnosticId = "RCGS0019";
    ...
    {
        if (context.Node is not ConversionOperatorDeclarationSyntax node)
        {
            return;
        }
