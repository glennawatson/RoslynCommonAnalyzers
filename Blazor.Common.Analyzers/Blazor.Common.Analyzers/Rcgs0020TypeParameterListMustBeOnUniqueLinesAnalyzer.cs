...
public sealed class Rcgs0020TypeParameterListMustBeOnUniqueLinesAnalyzer : DiagnosticAnalyzer
{
    /// <summary>The unique diagnostic identifier for this analyzer.</summary>
    internal const string DiagnosticId = "RCGS0020";
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        context.RegisterSyntaxNodeAction(Analyze, SyntaxKind.TypeParameterList);
    }
    ...
    {
        if (context.Node is not TypeParameterListSyntax node)
        {
            return;
        }

        context.HandleTypeParameterListSyntax(node, Rule);
    }
}
