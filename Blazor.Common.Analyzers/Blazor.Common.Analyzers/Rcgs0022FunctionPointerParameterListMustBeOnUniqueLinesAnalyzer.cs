...
public sealed class Rcgs0022FunctionPointerParameterListMustBeOnUniqueLinesAnalyzer : DiagnosticAnalyzer
{
    /// <summary>The unique diagnostic identifier for this analyzer.</summary>
    internal const string DiagnosticId = "RCGS0022";
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        context.RegisterSyntaxNodeAction(Analyze, SyntaxKind.FunctionPointerParameterList);
    }
    ...
    {
        if (context.Node is not FunctionPointerParameterListSyntax node)
        {
            return;
        }

        context.HandleFunctionPointerParameterListSyntax(node, Rule);
    }
}
