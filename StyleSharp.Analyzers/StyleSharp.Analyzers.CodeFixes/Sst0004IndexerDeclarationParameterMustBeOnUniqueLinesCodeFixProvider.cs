...
/// <summary>
/// A code fix provider for the <see cref="Sst0004IndexerDeclarationParameterMustBeOnUniqueLinesAnalyzer"/> analyzer.
/// </summary>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Sst0004IndexerDeclarationParameterMustBeOnUniqueLinesCodeFixProvider))]
[Shared]
            ...
            if (node is IndexerDeclarationSyntax syntaxNode)
            {
                ...
                context.RegisterCodeFix(
                    CodeAction.Create(
                        ...
                        nameof(Sst0004IndexerDeclarationParameterMustBeOnUniqueLinesCodeFixProvider) + "-Add"),
                    diagnostic);
                return;
            }
        }
