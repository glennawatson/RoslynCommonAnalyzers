...
/// <summary>
/// A code fix provider for the <see cref="Sst0008AttributeArgumentMustBeOnUniqueLinesAnalyzer"/> analyzer.
/// </summary>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Sst0008AttributeArgumentMustBeOnUniqueLinesCodeFixProvider))]
[Shared]
public sealed class Sst0008AttributeArgumentMustBeOnUniqueLinesCodeFixProvider : CodeFixProvider
{
    /// <inheritdoc/>
    public override ImmutableArray<string> FixableDiagnosticIds => ImmutableArrays.Of(Sst0008AttributeArgumentMustBeOnUniqueLinesAnalyzer.DiagnosticId);
            ...
            if (node is AttributeSyntax syntaxNode)
            {
                ...
                context.RegisterCodeFix(
                    CodeAction.Create(
                        ...
                        nameof(Sst0008AttributeArgumentMustBeOnUniqueLinesCodeFixProvider) + "-Add"),
                    diagnostic);
                return;
            }
        }
