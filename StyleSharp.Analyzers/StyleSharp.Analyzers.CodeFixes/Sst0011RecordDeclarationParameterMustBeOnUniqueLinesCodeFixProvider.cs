...
/// <summary>
/// A code fix provider for the <see cref="Sst0011RecordDeclarationParameterMustBeOnUniqueLinesAnalyzer"/> analyzer.
/// </summary>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Sst0011RecordDeclarationParameterMustBeOnUniqueLinesCodeFixProvider))]
[Shared]
public sealed class Sst0011RecordDeclarationParameterMustBeOnUniqueLinesCodeFixProvider : CodeFixProvider
{
    /// <inheritdoc/>
    public override ImmutableArray<string> FixableDiagnosticIds => ImmutableArrays.Of(Sst0011RecordDeclarationParameterMustBeOnUniqueLinesAnalyzer.DiagnosticId);
            ...
            if (node is RecordDeclarationSyntax syntaxNode)
            {
                ...
                context.RegisterCodeFix(
                    CodeAction.Create(
                        ...
                        nameof(Sst0011RecordDeclarationParameterMustBeOnUniqueLinesCodeFixProvider) + "-Add"),
                    diagnostic);
                return;
            }
        }
    ...
    private static Task<Document> FixAsync(Document document, SyntaxNode root, RecordDeclarationSyntax node)
    {
