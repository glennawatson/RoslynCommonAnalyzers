...
/// <summary>
/// A code fix provider for the <see cref="Sst0015ConstructorInitializerArgumentMustBeOnUniqueLinesAnalyzer"/> analyzer.
/// </summary>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Sst0015ConstructorInitializerArgumentMustBeOnUniqueLinesCodeFixProvider))]
[Shared]
public sealed class Sst0015ConstructorInitializerArgumentMustBeOnUniqueLinesCodeFixProvider : CodeFixProvider
{
    /// <inheritdoc/>
    public override ImmutableArray<string> FixableDiagnosticIds => ImmutableArrays.Of(Sst0015ConstructorInitializerArgumentMustBeOnUniqueLinesAnalyzer.DiagnosticId);
            ...
            if (node is ConstructorInitializerSyntax syntaxNode)
            {
                ...
                context.RegisterCodeFix(
                    CodeAction.Create(
                        ...
                        nameof(Sst0015ConstructorInitializerArgumentMustBeOnUniqueLinesCodeFixProvider) + "-Add"),
                    diagnostic);
                return;
            }
        }
    ...
    private static Task<Document> FixAsync(Document document, SyntaxNode root, ConstructorInitializerSyntax node)
    {
