...
/// <summary>
/// A code fix provider for the <see cref="Sst0017LocalFunctionStatementParameterMustBeOnUniqueLinesAnalyzer"/> analyzer.
/// </summary>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Sst0017LocalFunctionStatementParameterMustBeOnUniqueLinesCodeFixProvider))]
[Shared]
            ...
            if (node is LocalFunctionStatementSyntax syntaxNode)
            {
                ...
                context.RegisterCodeFix(
                    CodeAction.Create(
                        ...
                        nameof(Sst0017LocalFunctionStatementParameterMustBeOnUniqueLinesCodeFixProvider) + "-Add"),
                    diagnostic);
                return;
            }
        }
