...
/// <summary>
/// A code fix provider for the <see cref="Sst0020TypeParameterListMustBeOnUniqueLinesAnalyzer"/> analyzer.
/// </summary>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Sst0020TypeParameterListMustBeOnUniqueLinesCodeFixProvider))]
[Shared]
public sealed class Sst0020TypeParameterListMustBeOnUniqueLinesCodeFixProvider : CodeFixProvider
{
    /// <inheritdoc/>
    public override ImmutableArray<string> FixableDiagnosticIds => ImmutableArrays.Of(Sst0020TypeParameterListMustBeOnUniqueLinesAnalyzer.DiagnosticId);
            ...
            if (node is TypeParameterListSyntax syntaxNode)
            {
                ...
                context.RegisterCodeFix(
                    CodeAction.Create(
                        ...
                        nameof(Sst0020TypeParameterListMustBeOnUniqueLinesCodeFixProvider) + "-Add"),
                    diagnostic);
                return;
            }
        }
