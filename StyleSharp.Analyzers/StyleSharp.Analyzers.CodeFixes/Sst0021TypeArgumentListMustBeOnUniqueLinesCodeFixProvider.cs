...
/// <summary>
/// A code fix provider for the <see cref="Sst0021TypeArgumentListMustBeOnUniqueLinesAnalyzer"/> analyzer.
/// </summary>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Sst0021TypeArgumentListMustBeOnUniqueLinesCodeFixProvider))]
[Shared]
public sealed class Sst0021TypeArgumentListMustBeOnUniqueLinesCodeFixProvider : CodeFixProvider
{
    /// <inheritdoc/>
    public override ImmutableArray<string> FixableDiagnosticIds => ImmutableArrays.Of(Sst0021TypeArgumentListMustBeOnUniqueLinesAnalyzer.DiagnosticId);
            ...
            if (node is TypeArgumentListSyntax syntaxNode)
            {
                ...
                context.RegisterCodeFix(
                    CodeAction.Create(
                        ...
                        nameof(Sst0021TypeArgumentListMustBeOnUniqueLinesCodeFixProvider) + "-Add"),
                    diagnostic);
                return;
            }
        }
