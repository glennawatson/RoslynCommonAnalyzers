...
/// <summary>
/// A code fix provider for the <see cref="Sst0022FunctionPointerParameterListMustBeOnUniqueLinesAnalyzer"/> analyzer.
/// </summary>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Sst0022FunctionPointerParameterListMustBeOnUniqueLinesCodeFixProvider))]
[Shared]
public sealed class Sst0022FunctionPointerParameterListMustBeOnUniqueLinesCodeFixProvider : CodeFixProvider
{
    /// <inheritdoc/>
    public override ImmutableArray<string> FixableDiagnosticIds => ImmutableArrays.Of(Sst0022FunctionPointerParameterListMustBeOnUniqueLinesAnalyzer.DiagnosticId);
            ...
            if (node is FunctionPointerParameterListSyntax syntaxNode)
            {
                ...
                context.RegisterCodeFix(
                    CodeAction.Create(
                        ...
                        nameof(Sst0022FunctionPointerParameterListMustBeOnUniqueLinesCodeFixProvider) + "-Add"),
                    diagnostic);
                return;
            }
        }
