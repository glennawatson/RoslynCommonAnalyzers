...
using Verifysst0003 = StyleSharp.Analyzers.Tests.CSharpCodeFixVerifier<
    StyleSharp.Analyzers.Sst0003DelegateDeclarationParameterMustBeOnUniqueLinesAnalyzer,
    StyleSharp.Analyzers.Sst0003DelegateDeclarationParameterMustBeOnUniqueLinesCodeFixProvider>;

namespace StyleSharp.Analyzers.Tests;

/// <summary>Unit tests for the SST0003 analyzer that requires delegate declarations to keep their parameters on unique lines.</summary>
public class Sst0003DelegateDeclarationAnalyzersUnitTest
{
    ...
    public async Task InvalidJaggedEntryAsync(int number)
    {
        ...
        await Verifysst0003.VerifyAnalyzerAsync(test, Verifysst0003.Diagnostic("SST0003").WithSpan(startLine, startColumn, endLine, endColumn));
    }
    ...
    public async Task ValidCodeFixAsync(int number)
    {
        ...
        var expected = Verifysst0003.Diagnostic("SST0003").WithSpan(startLine, startColumn, endLine, endColumn);
