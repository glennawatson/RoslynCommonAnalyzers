...
using Verifysst0004 = StyleSharp.Analyzers.Tests.CSharpCodeFixVerifier<
    StyleSharp.Analyzers.Sst0004IndexerDeclarationParameterMustBeOnUniqueLinesAnalyzer,
    StyleSharp.Analyzers.Sst0004IndexerDeclarationParameterMustBeOnUniqueLinesCodeFixProvider>;

namespace StyleSharp.Analyzers.Tests;

/// <summary>Unit tests for the SST0004 analyzer that requires indexer declarations to keep their parameters on unique lines.</summary>
public class Sst0004IndexerDeclarationAnalyzersUnitTest
{
    ...
    public async Task InvalidJaggedEntryAsync(int number)
    {
        ...
        await Verifysst0004.VerifyAnalyzerAsync(test, Verifysst0004.Diagnostic("SST0004").WithSpan(startLine, startColumn, endLine, endColumn));
    }
    ...
    public async Task ValidCodeFixAsync(int number)
    {
        ...
        var expected = Verifysst0004.Diagnostic("SST0004").WithSpan(startLine, startColumn, endLine, endColumn);
