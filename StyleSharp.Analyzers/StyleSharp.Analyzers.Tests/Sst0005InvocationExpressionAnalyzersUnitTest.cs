...
using Verifysst0005 = StyleSharp.Analyzers.Tests.CSharpCodeFixVerifier<
    StyleSharp.Analyzers.Sst0005InvocationExpressionArgumentMustBeOnUniqueLinesAnalyzer,
    StyleSharp.Analyzers.Sst0005InvocationExpressionArgumentMustBeOnUniqueLinesCodeFixProvider>;

namespace StyleSharp.Analyzers.Tests;

/// <summary>Unit tests for the SST0005 analyzer that requires invocation expressions to keep their parameters on unique lines.</summary>
public class Sst0005InvocationExpressionAnalyzersUnitTest
{
    ...
    public async Task InvalidJaggedEntryAsync(int number)
    {
        ...
        await Verifysst0005.VerifyAnalyzerAsync(test, Verifysst0005.Diagnostic("SST0005").WithSpan(startLine, startColumn, endLine, endColumn));
    }
    ...
    public async Task ValidCodeFixAsync(int number)
    {
        ...
        var expected = Verifysst0005.Diagnostic("SST0005").WithSpan(startLine, startColumn, endLine, endColumn);
