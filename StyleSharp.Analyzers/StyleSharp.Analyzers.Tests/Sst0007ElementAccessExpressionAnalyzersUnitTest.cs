...
using Verifysst0007 = StyleSharp.Analyzers.Tests.CSharpCodeFixVerifier<
    StyleSharp.Analyzers.Sst0007ElementAccessExpressionArgumentMustBeOnUniqueLinesAnalyzer,
    StyleSharp.Analyzers.Sst0007ElementAccessExpressionArgumentMustBeOnUniqueLinesCodeFixProvider>;

namespace StyleSharp.Analyzers.Tests;

/// <summary>Unit tests for the SST0007 analyzer that requires element-access expressions to keep their parameters on unique lines.</summary>
public class Sst0007ElementAccessExpressionAnalyzersUnitTest
{
    ...
    public async Task InvalidJaggedEntryAsync(int number)
    {
        ...
        await Verifysst0007.VerifyAnalyzerAsync(test, Verifysst0007.Diagnostic("SST0007").WithSpan(startLine, startColumn, endLine, endColumn));
    }
    ...
    public async Task ValidCodeFixAsync(int number)
    {
        ...
        var expected = Verifysst0007.Diagnostic("SST0007").WithSpan(startLine, startColumn, endLine, endColumn);
