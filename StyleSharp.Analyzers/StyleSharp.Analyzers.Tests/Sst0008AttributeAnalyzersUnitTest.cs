...
using Verifysst0008 = StyleSharp.Analyzers.Tests.CSharpCodeFixVerifier<
    StyleSharp.Analyzers.Sst0008AttributeArgumentMustBeOnUniqueLinesAnalyzer,
    StyleSharp.Analyzers.Sst0008AttributeArgumentMustBeOnUniqueLinesCodeFixProvider>;

namespace StyleSharp.Analyzers.Tests;

/// <summary>Unit tests for the SST0008 analyzer that requires attribute argument lists to keep their parameters on unique lines.</summary>
public class Sst0008AttributeAnalyzersUnitTest
{
    ...
    public async Task InvalidJaggedEntryAsync(int number)
    {
        ...
        await Verifysst0008.VerifyAnalyzerAsync(test, Verifysst0008.Diagnostic("SST0008").WithSpan(startLine, startColumn, endLine, endColumn));
    }
    ...
    public async Task ValidCodeFixAsync(int number)
    {
        ...
        var expected = Verifysst0008.Diagnostic("SST0008").WithSpan(startLine, startColumn, endLine, endColumn);
