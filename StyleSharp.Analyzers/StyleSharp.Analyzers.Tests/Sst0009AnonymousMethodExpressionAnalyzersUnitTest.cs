...
using Verifysst0009 = StyleSharp.Analyzers.Tests.CSharpCodeFixVerifier<
    StyleSharp.Analyzers.Sst0009AnonymousMethodExpressionParameterMustBeOnUniqueLinesAnalyzer,
    StyleSharp.Analyzers.Sst0009AnonymousMethodExpressionParameterMustBeOnUniqueLinesCodeFixProvider>;

namespace StyleSharp.Analyzers.Tests;

/// <summary>Unit tests for the SST0009 analyzer that requires anonymous method expressions to keep their parameters on unique lines.</summary>
public class Sst0009AnonymousMethodExpressionAnalyzersUnitTest
{
    ...
    public async Task EmptyAsync()
    {
        ...
        await Verifysst0009.VerifyAnalyzerAsync(test);
    }
    ...
    public async Task InvalidJaggedEntryAsync(int number)
    {
        ...
        await Verifysst0009.VerifyAnalyzerAsync(test, Verifysst0009.Diagnostic("SST0009").WithSpan(startLine, startColumn, endLine, endColumn));
    }
    ...
    public async Task ValidCodeFixAsync(int number)
    {
        ...
        var expected = Verifysst0009.Diagnostic("SST0009").WithSpan(startLine, startColumn, endLine, endColumn);
        await Verifysst0009.VerifyCodeFixAsync(test, expected, fixtest);
    }
    ...
    private static (string Text, int StartLine, int StartColumn, int EndLine, int EndColumn) GenerateJagged(int number)
    {
        var classGenerator = new ClassGeneratorBuilder();
        classGenerator.Init();
        var (startLine, startColumn, endLine, endColumn) = classGenerator.AnonymousMethodExpressionJagged(number);
