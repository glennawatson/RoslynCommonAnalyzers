...
using Verifysst0012 = StyleSharp.Analyzers.Tests.CSharpCodeFixVerifier<
    StyleSharp.Analyzers.Sst0012ClassDeclarationParameterMustBeOnUniqueLinesAnalyzer,
    StyleSharp.Analyzers.Sst0012ClassDeclarationParameterMustBeOnUniqueLinesCodeFixProvider>;

namespace StyleSharp.Analyzers.Tests;

/// <summary>Unit tests for the SST0012 analyzer that requires class declaration primary constructor parameters to be on unique lines.</summary>
public class Sst0012ClassDeclarationAnalyzersUnitTest
{
