...
using Verifysst0014 = StyleSharp.Analyzers.Tests.CSharpCodeFixVerifier<
    StyleSharp.Analyzers.Sst0014ImplicitObjectCreationExpressionArgumentMustBeOnUniqueLinesAnalyzer,
    StyleSharp.Analyzers.Sst0014ImplicitObjectCreationExpressionArgumentMustBeOnUniqueLinesCodeFixProvider>;

namespace StyleSharp.Analyzers.Tests;

/// <summary>Unit tests for the SST0014 analyzer that requires implicit object creation arguments to be on unique lines.</summary>
public class Sst0014ImplicitObjectCreationExpressionAnalyzersUnitTest
{
    ...
    public async Task InvalidAsync()
    {
        const string test = """
            public class Foo
            {
                ...
                public static Foo Create() => {|SST0014:new(
                    1, 2)|};
            }
            """;
