...
using Verifysst0015 = StyleSharp.Analyzers.Tests.CSharpCodeFixVerifier<
    StyleSharp.Analyzers.Sst0015ConstructorInitializerArgumentMustBeOnUniqueLinesAnalyzer,
    StyleSharp.Analyzers.Sst0015ConstructorInitializerArgumentMustBeOnUniqueLinesCodeFixProvider>;

namespace StyleSharp.Analyzers.Tests;

/// <summary>Unit tests for the SST0015 analyzer that requires constructor initializer arguments to be on unique lines.</summary>
public class Sst0015ConstructorInitializerAnalyzersUnitTest
{
