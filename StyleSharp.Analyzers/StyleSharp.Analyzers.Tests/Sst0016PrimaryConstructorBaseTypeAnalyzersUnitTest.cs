...
using Verifysst0016 = StyleSharp.Analyzers.Tests.CSharpCodeFixVerifier<
    StyleSharp.Analyzers.Sst0016PrimaryConstructorBaseTypeArgumentMustBeOnUniqueLinesAnalyzer,
    StyleSharp.Analyzers.Sst0016PrimaryConstructorBaseTypeArgumentMustBeOnUniqueLinesCodeFixProvider>;

namespace StyleSharp.Analyzers.Tests;

/// <summary>Unit tests for the SST0016 analyzer that requires primary constructor base type arguments to be on unique lines.</summary>
public class Sst0016PrimaryConstructorBaseTypeAnalyzersUnitTest
{
    ...
    public async Task InvalidAsync()
    {
        const string test = """
            public record Bar(int x, int y);
            public record Foo(int a, int b) : {|SST0016:Bar(
                a, b)|};
            namespace System.Runtime.CompilerServices { internal static class IsExternalInit { } }
            """;
