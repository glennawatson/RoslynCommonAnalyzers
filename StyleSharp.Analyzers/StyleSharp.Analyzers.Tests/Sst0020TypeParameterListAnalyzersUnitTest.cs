...
using Verifysst0020 = StyleSharp.Analyzers.Tests.CSharpCodeFixVerifier<
    StyleSharp.Analyzers.Sst0020TypeParameterListMustBeOnUniqueLinesAnalyzer,
    StyleSharp.Analyzers.Sst0020TypeParameterListMustBeOnUniqueLinesCodeFixProvider>;

namespace StyleSharp.Analyzers.Tests;

/// <summary>Unit tests for the SST0020 analyzer that requires type parameter lists to be on unique lines.</summary>
public class Sst0020TypeParameterListAnalyzersUnitTest
{
