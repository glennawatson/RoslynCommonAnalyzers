...
using Verifysst0021 = StyleSharp.Analyzers.Tests.CSharpCodeFixVerifier<
    StyleSharp.Analyzers.Sst0021TypeArgumentListMustBeOnUniqueLinesAnalyzer,
    StyleSharp.Analyzers.Sst0021TypeArgumentListMustBeOnUniqueLinesCodeFixProvider>;

namespace StyleSharp.Analyzers.Tests;

/// <summary>Unit tests for the SST0021 analyzer that requires type argument lists to be on unique lines.</summary>
public class Sst0021TypeArgumentListAnalyzersUnitTest
{
    ...
    public async Task InvalidAsync()
    {
        const string test = """
            public class Foo
            {
                private readonly System.Collections.Generic.Dictionary{|SST0021:<
                    int, string>|} _map = new();
            }
            """;
