...
using Verifysst0009 = StyleSharp.Analyzers.Tests.CSharpCodeFixVerifier<
    StyleSharp.Analyzers.Sst1158AnonymousMethodExpressionParameterMustBeOnUniqueLinesAnalyzer,
    StyleSharp.Analyzers.Sst1158AnonymousMethodExpressionParameterMustBeOnUniqueLinesCodeFixProvider>;

namespace StyleSharp.Analyzers.Tests;

/// <summary>Unit tests for the SST1158 analyzer that requires anonymous method expressions to keep their parameters on unique lines.</summary>
public class Sst1158AnonymousMethodExpressionAnalyzersUnitTest
{
    ...
    public async Task InvalidJaggedEntryAsync(int number)
    {
        ...
        await Verifysst0009.VerifyAnalyzerAsync(test, Verifysst0009.Diagnostic("SST1158").WithSpan(startLine, startColumn, endLine, endColumn));
    }
    ...
    public async Task ValidCodeFixAsync(int number)
    {
        ...
        var expected = Verifysst0009.Diagnostic("SST1158").WithSpan(startLine, startColumn, endLine, endColumn);
