...
/// <c>unset</c> or empty the rule does nothing. Unlike the SDK's IDE0073, this is
...
public sealed class FileHeaderAnalyzer : DiagnosticAnalyzer
{
    ...
    private static void Analyze(SyntaxTreeAnalysisContext context)
    {
        ...
        context.ReportDiagnostic(Diagnostic.Create(DocumentationRules.FileHeader, Location.Create(context.Tree, new TextSpan(0, 0)), properties));
    }
