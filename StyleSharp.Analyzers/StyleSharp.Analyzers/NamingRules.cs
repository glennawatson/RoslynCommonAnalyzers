...
internal static class NamingRules
{
    ...
    public static readonly DiagnosticDescriptor FieldLowerCase = CreateOptIn(
        ...
        "Field names begin with a lower-case letter (StyleCop SA1306). Off by default — it conflicts with the runtime _camelCase convention enforced by SST1309.");
    ...
    public static readonly DiagnosticDescriptor NoFieldPrefix = CreateOptIn(
        ...
        "Field names are not prefixed with 'm_', 's_', or 't_' (StyleCop SA1308). Off by default — the repository allows the 's_' prefix for static fields.");
    ...
    public static readonly DiagnosticDescriptor FieldNoUnderscore = CreateOptIn(
        ...
        "Field names do not contain underscores (StyleCop SA1310). Off by default — it conflicts with the runtime _camelCase convention enforced by SST1309.");
