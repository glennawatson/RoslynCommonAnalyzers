...
internal static class UsingClassification
{
    ...
    {
        var text = directive.Name?.ToString();
        return text is not null && (string.Equals(text, "System", StringComparison.Ordinal) || text.StartsWith("System.", StringComparison.Ordinal));
    }
