...
| `stylesharp.allowed_escape_methods` | [SST2403](rules/SST2403.md) | comma-separated method names | empty |
| `stylesharp.magic_number_allowed_values` | [SST1471](rules/SST1471.md) | comma-separated numbers | `-1, 0, 1` |
| `stylesharp.allow_capacity_arguments` | [SST1471](rules/SST1471.md) | `true`, `false` | `false` |
...
| `stylesharp.report_value_type_payloads` | [SST2338](rules/SST2338.md) | `true`, `false` | `false` |
| `stylesharp.unread_parameter_include_public_api` | [SST1461](rules/SST1461.md) | `true`, `false` | `false` |
