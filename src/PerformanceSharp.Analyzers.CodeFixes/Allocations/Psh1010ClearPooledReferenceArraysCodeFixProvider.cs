...
[Shared]
public sealed class Psh1010ClearPooledReferenceArraysCodeFixProvider : CodeFixProvider
{
    ...
    public override Task RegisterCodeFixesAsync(CodeFixContext context) =>
        ReplaceNodeCodeFix.RegisterAsync(context, "Clear the array on return", nameof(Psh1010ClearPooledReferenceArraysCodeFixProvider), CanRewrite, TryRewrite);
