...
[Shared]
public sealed class Psh1114FreezeStaticLookupsCodeFixProvider : CodeFixProvider
{
    ...
    public override Task RegisterCodeFixesAsync(CodeFixContext context) =>
        ReplaceNodeCodeFix.RegisterAsync(context, "Freeze the lookup", nameof(Psh1114FreezeStaticLookupsCodeFixProvider), CanRewrite, TryRewrite);
