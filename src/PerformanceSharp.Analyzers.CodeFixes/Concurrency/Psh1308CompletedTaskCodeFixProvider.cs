...
[Shared]
public sealed class Psh1308CompletedTaskCodeFixProvider : CodeFixProvider
{
    ...
    public override Task RegisterCodeFixesAsync(CodeFixContext context) =>
        ReplaceNodeCodeFix.RegisterAsync(context, "Use Task.CompletedTask", nameof(Psh1308CompletedTaskCodeFixProvider), CanRewrite, TryRewrite);
