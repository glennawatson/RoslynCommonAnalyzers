...
public sealed class Psh1403RemoveRedundantDefaultInitializationAnalyzer : DiagnosticAnalyzer
{
    ...
    private static readonly ImmutableArray<DiagnosticDescriptor> SupportedDiagnosticsValue = ImmutableArrays.Of(ApiSelectionRules.RemoveRedundantDefaultInitialization);
