...
public sealed class Psh1601JsInteropInLoopAnalyzer : DiagnosticAnalyzer
{
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        CompilationStateRegistration.RegisterSyntaxNodeAction(
            context,
            static compilation => new LazyCompilationValue<InteropGate?>(compilation, CreateGate),
            Analyze,
    ...
    /// <param name="gate">The interop types resolved on first demand.</param>
    private static void Analyze(in SyntaxNodeAnalysisContext context, LazyCompilationValue<InteropGate?> gate)
    {
