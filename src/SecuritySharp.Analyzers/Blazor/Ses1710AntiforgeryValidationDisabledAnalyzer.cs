...
public sealed class Ses1710AntiforgeryValidationDisabledAnalyzer : DiagnosticAnalyzer
{
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        CompilationStateRegistration.RegisterSyntaxNodeAction(
            context,
            static compilation => new LazyMetadataType(compilation, RequireAntiforgeryTokenAttributeMetadataName),
            AnalyzeAttribute,
    ...
    private static void AnalyzeAttribute(in SyntaxNodeAnalysisContext context, LazyMetadataType types)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        for (var i = 0; i < arguments.Count; i++)
        {
            ...
            // A property/field initializer ('Name = ...') maps to no constructor parameter and never carries 'required'.
            if (string.Equals(AttributeArgumentParameter.NameOf(argument, constructor, ref positionalIndex), RequiredParameterName, StringComparison.Ordinal)
