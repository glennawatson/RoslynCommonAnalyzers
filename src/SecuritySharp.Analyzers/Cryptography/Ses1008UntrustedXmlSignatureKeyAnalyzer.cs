...
public sealed class Ses1008UntrustedXmlSignatureKeyAnalyzer : DiagnosticAnalyzer
{
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        CompilationStateRegistration.RegisterSyntaxNodeAction(
            context,
            static compilation => new LazyMetadataType(compilation, SignedXmlMetadataName),
            AnalyzeInvocation,
    ...
    private static void AnalyzeInvocation(in SyntaxNodeAnalysisContext context, LazyMetadataType signedXmlType)
    {
        ...
        if (signedXmlType.Get() is not { } resolvedSignedXmlType
