...
/// <summary>Factory for the empty <see cref="ImmutableDictionary{TKey, TValue}"/> that analyzers hand to <c>Diagnostic.Create</c> as a property bag.</summary>
/// <remarks>
...
internal static class ImmutableDictionaries
{
    ...
    internal static ImmutableDictionary<TKey, TValue> Empty<TKey, TValue>()
        where TKey : notnull
