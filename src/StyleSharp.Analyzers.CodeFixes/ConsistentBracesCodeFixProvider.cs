...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ConsistentBracesCodeFixProvider))]
[Shared]
public sealed class ConsistentBracesCodeFixProvider : CodeFixProvider
{
    /// <inheritdoc/>
        ...
        foreach (var diagnostic in context.Diagnostics)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    ...
                    equivalenceKey: nameof(ConsistentBracesCodeFixProvider)),
                diagnostic);
        }
    }
