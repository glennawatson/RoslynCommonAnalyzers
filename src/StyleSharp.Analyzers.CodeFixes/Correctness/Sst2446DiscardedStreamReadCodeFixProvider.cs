...
[Shared]
public sealed class Sst2446DiscardedStreamReadCodeFixProvider : CodeFixProvider
{
    ...
    private static bool CanRewrite(SyntaxNode root, SemanticModel model, Diagnostic diagnostic) =>
        (root.FindNode(diagnostic.Location.SourceSpan)is { } node
            ...
            && InvokedSimpleName.Of(invocation) == Sst2446DiscardedStreamReadAnalyzer.ReadAsyncName)
