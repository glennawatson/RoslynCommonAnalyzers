...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(FileEndingCodeFixProvider))]
[Shared]
public sealed class FileEndingCodeFixProvider : CodeFixProvider
{
    /// <inheritdoc/>
        ...
        foreach (var diagnostic in context.Diagnostics)
        {
            context.RegisterCodeFix(
                CodeAction.Create(
                    ...
                    equivalenceKey: nameof(FileEndingCodeFixProvider)),
                diagnostic);
        }
