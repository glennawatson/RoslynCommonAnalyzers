...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(FileStartBlankLinesCodeFixProvider))]
[Shared]
public sealed class FileStartBlankLinesCodeFixProvider : CodeFixProvider
{
    /// <inheritdoc/>
        ...
        foreach (var diagnostic in context.Diagnostics)
        {
            context.RegisterCodeFix(
                CodeAction.Create(
                    ...
                    equivalenceKey: nameof(FileStartBlankLinesCodeFixProvider)),
                diagnostic);
        }
