...
/// <summary>Computes the text a comment removal deletes, so the surrounding layout survives it.</summary>
internal static class CommentRemovalHelper
{
    /// <summary>Computes the span to delete for a comment.</summary>
    ...
    public static TextSpan ComputeRemoval(SourceText text, TextSpan span)
    {
        ...
        {
            // The comment owns its line: drop the line, including its terminating newline.
