...
/// and StyleCop conventions. Generic types use a file-name-safe arity marker chosen by the
/// <c>stylesharp.file_naming_convention</c> option: <c>stylecop</c> (default) renders the type
...
internal static class TypeFileNaming
{
    ...
    /// <summary>Reads the configured generic file-naming convention for a rule, falling back to the general key, then the StyleCop default.</summary>
