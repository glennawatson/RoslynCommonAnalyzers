...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Sst2200PreferFieldKeywordCodeFixProvider))]
[Shared]
public sealed class Sst2200PreferFieldKeywordCodeFixProvider : CodeFixProvider
{
    /// <inheritdoc/>
