...
[Shared]
public sealed class Sst2282ReferenceEqualsNullPatternCodeFixProvider : CodeFixProvider
{
    ...
    private static NodeReplacement? TryRewrite(SyntaxNode root, Diagnostic diagnostic)
    {
        ...
        var operand = ExpressionShapes.WalkDownParentheses(nonNullOperand).WithoutTrivia();
