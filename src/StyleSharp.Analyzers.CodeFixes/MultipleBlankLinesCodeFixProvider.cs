...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(MultipleBlankLinesCodeFixProvider))]
[Shared]
public sealed class MultipleBlankLinesCodeFixProvider : CodeFixProvider
{
    /// <inheritdoc/>
        ...
        foreach (var diagnostic in context.Diagnostics)
        {
            context.RegisterCodeFix(
                CodeAction.Create(
                    ...
                    equivalenceKey: nameof(MultipleBlankLinesCodeFixProvider)),
                diagnostic);
        }
