...
[Shared]
public sealed class Sst1219DefaultSectionLastCodeFixProvider : CodeFixProvider
{
    ...
    private static NodeReplacement? TryRewrite(SyntaxNode root, Diagnostic diagnostic)
    {
        ...
        var index = switchStatement.Sections.IndexOf(section);
        return index < 0 || index == switchStatement.Sections.Count - 1 ? null : new NodeReplacement(switchStatement, Move(switchStatement, index), current => Rewrite(current, index));
    }
