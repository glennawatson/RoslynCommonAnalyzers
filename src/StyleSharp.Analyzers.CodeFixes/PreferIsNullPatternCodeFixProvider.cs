...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(PreferIsNullPatternCodeFixProvider))]
[Shared]
public sealed class PreferIsNullPatternCodeFixProvider : CodeFixProvider
{
    ...
    {
        _ = PreferIsNullPatternAnalyzer.TryGetNullComparison(binary, out var operand);
