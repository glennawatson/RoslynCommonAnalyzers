...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(PreferOrPatternCodeFixProvider))]
[Shared]
public sealed class PreferOrPatternCodeFixProvider : CodeFixProvider
{
    /// <inheritdoc/>
