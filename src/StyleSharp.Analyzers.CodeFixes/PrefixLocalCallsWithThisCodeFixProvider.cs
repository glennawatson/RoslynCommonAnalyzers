...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(PrefixLocalCallsWithThisCodeFixProvider))]
[Shared]
public sealed class PrefixLocalCallsWithThisCodeFixProvider : CodeFixProvider
{
    /// <inheritdoc/>
