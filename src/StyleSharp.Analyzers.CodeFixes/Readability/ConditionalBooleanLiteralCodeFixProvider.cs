...
public sealed class ConditionalBooleanLiteralCodeFixProvider : CodeFixProvider, IBatchFixableCodeFix
{
    ...
    public override Task RegisterCodeFixesAsync(CodeFixContext context) =>
        ReplaceNodeCodeFix.RegisterAsync(context, "Use the condition directly", nameof(ConditionalBooleanLiteralCodeFixProvider), CanRewrite, TryRewrite);
    ...
    private static bool CanRewrite(SyntaxNode root, Diagnostic diagnostic) =>
        root.FindNode(diagnostic.Location.SourceSpan) is ConditionalExpressionSyntax;
