...
/// <summary>
/// A code fix provider for the <see cref="Sst1150ConstructorDeclarationParameterMustBeOnUniqueLinesAnalyzer"/> analyzer.
/// </summary>
...
[Shared]
public sealed class Sst1150ConstructorDeclarationParameterMustBeOnUniqueLinesCodeFixProvider : CodeFixProvider, IBatchFixableCodeFix
{
    /// <inheritdoc/>
    ...
    public override Task RegisterCodeFixesAsync(CodeFixContext context)
        => ReplaceNodeCodeFix.RegisterAsync(context, CodeFixResources.SST1150CodeFixTitle, nameof(Sst1150ConstructorDeclarationParameterMustBeOnUniqueLinesCodeFixProvider) + "-Add", TryRewrite);
