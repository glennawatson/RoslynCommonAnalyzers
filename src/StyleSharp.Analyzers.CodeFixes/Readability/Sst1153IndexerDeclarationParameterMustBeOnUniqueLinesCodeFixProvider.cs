...
[Shared]
public sealed class Sst1153IndexerDeclarationParameterMustBeOnUniqueLinesCodeFixProvider : CodeFixProvider
{
    /// <summary>Resolves the reported indexer declaration and splits its parameters onto their own lines.</summary>
    internal static readonly UniqueLineFix<IndexerDeclarationSyntax> Fix = new(UniqueLineRewrites.IndexerParameters);
