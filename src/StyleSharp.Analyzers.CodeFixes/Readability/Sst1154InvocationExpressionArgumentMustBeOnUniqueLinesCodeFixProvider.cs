...
/// <summary>A code fix provider for the <see cref="Sst1154InvocationExpressionArgumentMustBeOnUniqueLinesAnalyzer"/> analyzer.</summary>
...
{
    /// <summary>Resolves the reported invocation expression and splits its arguments onto their own lines.</summary>
    internal static readonly UniqueLineFix<InvocationExpressionSyntax> Fix = new(UniqueLineRewrites.InvocationArguments);
