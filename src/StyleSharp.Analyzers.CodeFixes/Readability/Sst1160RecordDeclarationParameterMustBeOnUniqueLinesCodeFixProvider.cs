...
/// <summary>A code fix provider for the <see cref="Sst1160RecordDeclarationParameterMustBeOnUniqueLinesAnalyzer"/> analyzer.</summary>
...
{
    /// <summary>Resolves the reported record declaration and splits its parameters onto their own lines.</summary>
    internal static readonly UniqueLineFix<RecordDeclarationSyntax> Fix = new(UniqueLineRewrites.RecordParameters);
