...
{
    /// <summary>Resolves the reported local function statement and splits its parameters onto their own lines.</summary>
    internal static readonly UniqueLineFix<LocalFunctionStatementSyntax> Fix = new(UniqueLineRewrites.LocalFunctionParameters);
