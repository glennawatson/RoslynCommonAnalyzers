...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(RequireBracesCodeFixProvider))]
[Shared]
public sealed class RequireBracesCodeFixProvider : CodeFixProvider
{
    /// <inheritdoc/>
        ...
        foreach (var diagnostic in context.Diagnostics)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    ...
                    equivalenceKey: nameof(RequireBracesCodeFixProvider)),
                diagnostic);
        }
    }
