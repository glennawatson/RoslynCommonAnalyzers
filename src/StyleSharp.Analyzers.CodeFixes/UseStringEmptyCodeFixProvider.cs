...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(UseStringEmptyCodeFixProvider))]
[Shared]
public sealed class UseStringEmptyCodeFixProvider : CodeFixProvider
{
    /// <inheritdoc/>
        ...
        foreach (var diagnostic in context.Diagnostics)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    ...
                    equivalenceKey: nameof(UseStringEmptyCodeFixProvider)),
                diagnostic);
        }
    }
