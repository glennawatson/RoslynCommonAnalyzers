...
public sealed class Sst2434ArrayCovarianceAnalyzer : DiagnosticAnalyzer
{
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        {
            var readOnlySpanResolves = LazyCompilationProbe.CreateSynchronized(start.Compilation, HasReadOnlySpan);
    ...
    private static void AnalyzeConversion(in OperationAnalysisContext context, LazyCompilationProbe readOnlySpanResolves)
    {
    ...
    /// </remarks>
    private static void AnalyzeCoalesce(in OperationAnalysisContext context, LazyCompilationProbe readOnlySpanResolves)
    {
    ...
    private static void Report(
        ...
        SyntaxNode syntax,
        LazyCompilationProbe readOnlySpanResolves)
    {
    ...
    /// <summary>Returns whether the compilation has the read-only span type.</summary>
