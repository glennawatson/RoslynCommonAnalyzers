...
public sealed class Sst2486PreferAssemblyLoadAnalyzer : DiagnosticAnalyzer
{
    ...
    {
        var assemblyTypes = new LazyMetadataType(context.Compilation, "System.Reflection.Assembly");
    ...
    private static void Analyze(in SyntaxNodeAnalysisContext context, LazyMetadataType assemblyTypes)
    {
