...
public sealed class Sst2491AwaitableReturnedFromTeardownAnalyzer : DiagnosticAnalyzer
{
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        CompilationStateRegistration.RegisterSyntaxNodeAction(
            context,
            static compilation => new LazyCompilationValue<TeardownTaskTypes>(
                compilation,
                TeardownTaskTypes.Resolve,
                runOnce: true),
            AnalyzeReturn,
    ...
    private static void AnalyzeReturn(in SyntaxNodeAnalysisContext context, LazyCompilationValue<TeardownTaskTypes> taskTypes)
    {
    ...
    private static bool IsNonAsyncTaskMethod(in SyntaxNodeAnalysisContext context, SyntaxNode functionNode, LazyCompilationValue<TeardownTaskTypes> taskTypes)
    {
