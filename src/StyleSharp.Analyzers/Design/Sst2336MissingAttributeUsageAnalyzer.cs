...
public sealed class Sst2336MissingAttributeUsageAnalyzer : DiagnosticAnalyzer
{
    ...
    /// <summary>The metadata names AttributeTypes resolves, in slot order.</summary>
    private static readonly string[] AttributeTypesMetadataNames =
    [
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        CompilationStateRegistration.RegisterSymbolAction(
            context,
            static compilation => new LazyMetadataTypes(compilation, AttributeTypesMetadataNames),
            Analyze,
    ...
    private static void Analyze(in SymbolAnalysisContext context, LazyMetadataTypes types)
    {
