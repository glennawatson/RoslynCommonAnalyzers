...
/// </remarks>
internal static class ArgumentsOrParameterOnSameLineHelperExtensions
{
        /// <summary>
        /// Gives the analysis context one handler per list-bearing syntax kind, each reporting the
        /// supplied rule when that list is laid out jaggedly.
        /// </summary>
        /// <param name="context">
        /// The receiver every handler runs against: it supplies the node under analysis and is where
        /// the diagnostic is reported when that node's list is jagged.
        /// </param>
        extension(in SyntaxNodeAnalysisContext context)
    {
        ...
        internal void HandleFunctionPointerParameterListSyntax(FunctionPointerParameterListSyntax? functionPointerParameterList, DiagnosticDescriptor rule)
        {
        ...
        /// <param name="rule">The diagnostic descriptor to report.</param>
        internal void HandleTypeArgumentListSyntax(TypeArgumentListSyntax? typeArgumentList, DiagnosticDescriptor rule)
        {
        ...
        /// <param name="rule">The diagnostic descriptor to report.</param>
        internal void HandleTypeParameterListSyntax(TypeParameterListSyntax? typeParameterList, DiagnosticDescriptor rule)
        {
        ...
        /// <param name="rule">The diagnostic descriptor to report.</param>
        internal void HandleParameterListSyntax(BracketedParameterListSyntax? parameterList, DiagnosticDescriptor rule)
        {
        ...
        /// <param name="rule">The diagnostic descriptor to report.</param>
        internal void HandleParameterListSyntax(ParameterListSyntax? parameterList, DiagnosticDescriptor rule)
        {
            if (parameterList is null)
            {
                return;
        ...
        /// <param name="rule">The diagnostic descriptor to report.</param>
        internal void HandleArgumentListSyntax(AttributeArgumentListSyntax? argumentList, DiagnosticDescriptor rule)
        {
        ...
        /// <param name="rule">The diagnostic descriptor to report.</param>
        internal void HandleArgumentListSyntax(BracketedArgumentListSyntax? argumentList, DiagnosticDescriptor rule)
        {
            if (argumentList is null)
            {
                return;
        ...
        /// <param name="rule">The diagnostic descriptor to report.</param>
        internal void HandleArgumentListSyntax(ArgumentListSyntax? argumentList, DiagnosticDescriptor rule)
        {
            if (argumentList is null)
            {
                return;
    ...
    /// <param name="rule">The diagnostic descriptor to report.</param>
        internal static void Analyze<T>(in SyntaxNodeAnalysisContext context, SyntaxNode listNode, in SeparatedSyntaxList<T> list, DiagnosticDescriptor rule)
            where T : SyntaxNode
        {
    ...
    /// <summary>Returns whether the items in the list are laid out jaggedly (some share a line while others wrap).</summary>
    /// <typeparam name="T">The type of syntax node contained in the list.</typeparam>
    /// <param name="listNode">The node owning the items; its opening delimiter anchors the first line.</param>
    /// <param name="list">The separated list of arguments or parameters.</param>
