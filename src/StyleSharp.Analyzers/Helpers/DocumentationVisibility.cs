...
/// <see cref="DocumentationCoverage"/> options, mirroring the analyzer's
...
internal static class DocumentationVisibility
{
    ...
    public static bool NeedsDocumentation(SyntaxNode member, in DocumentationCoverage coverage)
    {
        ...
        // With private documentation enabled every remaining element is in scope (the analyzer only carves
    ...
    /// <see cref="DocumentationCoverage.PrivateFields"/> toggle when it is private — matching the analyzer's
