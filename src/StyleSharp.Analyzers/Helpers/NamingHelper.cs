...
internal static class NamingHelper
{
    ...
    internal static bool BeginsWithCapitalI(string name) => name.Length > 0 && name[0] == 'I';
    ...
    internal static bool BeginsWithCapitalT(string name) => name.Length > 0 && name[0] == 'T';
    ...
    internal static bool BeginsWithUpperCase(string name) => name.Length > 0 && char.IsUpper(name[0]);
    ...
    internal static bool BeginsWithLowerCase(string name) => name.Length > 0 && char.IsLower(name[0]);
    ...
    internal static bool BeginsWithUnderscore(string name) => name.Length > 0 && name[0] == '_';
    ...
    internal static bool IsAllUnderscores(string name)
    {
        if (name.Length == 0)
        {
            return false;
    ...
    internal static string SuggestPascalCaseName(string name)
    {
    ...
    internal static string SuggestUnderscoreCamelCase(string name) => $"_{SuggestCamelCase(name)}";
    ...
    internal static string SuggestPrefixed(string name, char prefix) => prefix + SuggestPascalCase(name);
