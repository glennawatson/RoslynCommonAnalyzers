...
/// StyleSharp counterparts of the analyzer's SA15xx layout rules. the rule has no
/// counterpart here — the repository defers brace-omission to the analyzer's the rule.
/// </summary>
