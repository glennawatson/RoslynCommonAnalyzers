...
public sealed class Sst1484ShadowedDeclarationAnalyzer : DiagnosticAnalyzer
{
    ...
    {
        var tablesByType = new Lazy<ConcurrentDictionary<TypeDeclarationSyntax, ShadowedMemberTable>>(static () => new(concurrencyLevel: 4, capacity: 31));
        var optionsByTree = new Lazy<ConcurrentDictionary<SyntaxTree, ShadowedDeclarationOptions>>(static () => new(concurrencyLevel: 4, capacity: 31));
    ...
    private static void Analyze(
        ...
        Lazy<ConcurrentDictionary<TypeDeclarationSyntax, ShadowedMemberTable>> tablesByType,
