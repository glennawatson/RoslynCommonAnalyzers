...
public sealed class Sst1496AbstractTypeWithoutAbstractMembersAnalyzer : DiagnosticAnalyzer
{
    ...
    private static readonly ImmutableArray<DiagnosticDescriptor> SupportedDiagnosticsValue = ImmutableArrays.Of(MaintainabilityRules.AbstractTypeWithoutAbstractMembers);
