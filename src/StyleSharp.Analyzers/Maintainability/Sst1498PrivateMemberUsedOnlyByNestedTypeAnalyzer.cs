...
public sealed class Sst1498PrivateMemberUsedOnlyByNestedTypeAnalyzer : DiagnosticAnalyzer
{
    ...
    private static readonly ImmutableArray<DiagnosticDescriptor> SupportedDiagnosticsValue = ImmutableArrays.Of(MaintainabilityRules.PrivateMemberUsedOnlyByNestedType);
