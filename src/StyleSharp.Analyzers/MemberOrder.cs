...
/// lexicographically by the analyzer's default precedence — kind, accessibility,
...
internal readonly record struct MemberOrder(int Kind, int Access, int Constant, int Static, int ReadOnly)
{
    ...
    /// <summary>Compares this rank with another in the analyzer's precedence order.</summary>
    ...
    /// <summary>Compares two member-order values in the analyzer's precedence order.</summary>
