...
/// <summary>
/// Reports value-flow, cast, and pattern preferences with syntax-first candidate
/// filtering (SST2220–SST2228, SST2231, SST2232). The LINQ rules formerly bundled
/// here (SST2229, SST2230, SST2233) moved to PerformanceSharp.Analyzers as
/// PSH1101, PSH1102, and PSH1100.
/// </summary>
...
public sealed class ModernSyntaxValueAnalyzer : DiagnosticAnalyzer
{
    ...
    /// <summary>Reports generic <c>nameof</c> cleanup for one invocation.</summary>
    /// <param name="context">The syntax context.</param>
