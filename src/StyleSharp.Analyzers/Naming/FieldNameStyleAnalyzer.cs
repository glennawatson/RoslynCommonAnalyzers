...
/// <summary>
/// Reports the the analyzer field-name style rules that conflict with this repository's runtime
...
/// <c>.editorconfig</c> only if you prefer the the analyzer style over SST1309.
/// </summary>
...
public sealed class FieldNameStyleAnalyzer : DiagnosticAnalyzer
{
    ...
    /// <summary>Checks each declared field name against the the analyzer field-name style rules.</summary>
