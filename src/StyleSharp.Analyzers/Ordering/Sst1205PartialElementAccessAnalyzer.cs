...
public sealed class Sst1205PartialElementAccessAnalyzer : DiagnosticAnalyzer
{
    ...
    private static readonly ImmutableArray<DiagnosticDescriptor> SupportedDiagnosticsValue = ImmutableArrays.Of(OrderingRules.PartialElementAccess);
    ...
    private static void Analyze(SyntaxNodeAnalysisContext context)
    {
        ...
        var properties = ImmutableDictionary<string, string?>.Empty.Add(Sst1400AccessModifierAnalyzer.ModifierKey, defaultModifier);
