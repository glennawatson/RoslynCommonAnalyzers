...
/// Members are ordered by the analyzer's default precedence: kind, then accessibility,
...
internal static class OrderingRules
{
    ...
    /// <summary>SST1215 — instance readonly fields should appear before instance non-readonly fields (mirrors the rule).</summary>
