...
public sealed class Sst1134AttributesOnSeparateLinesAnalyzer : DiagnosticAnalyzer
{
    ...
    private static readonly ImmutableArray<DiagnosticDescriptor> SupportedDiagnosticsValue = ImmutableArrays.Of(ReadabilityRules.AttributesOnSeparateLines);
    ...
    private static void Analyze(SyntaxNodeAnalysisContext context)
    {
        ...
        if (LayoutHelpers.LineOf(text, list.CloseBracketToken.Span.End) != LayoutHelpers.LineOf(text, next.SpanStart))
        {
            return;
        }
