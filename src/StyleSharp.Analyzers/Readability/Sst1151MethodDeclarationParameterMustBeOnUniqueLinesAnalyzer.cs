...
public sealed class Sst1151MethodDeclarationParameterMustBeOnUniqueLinesAnalyzer : DiagnosticAnalyzer
{
    /// <summary>The unique diagnostic identifier for this analyzer.</summary>
    internal const string DiagnosticId = "SST1151";
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        UniqueLineRule.Register<MethodDeclarationSyntax>(
            context,
            Rule,
