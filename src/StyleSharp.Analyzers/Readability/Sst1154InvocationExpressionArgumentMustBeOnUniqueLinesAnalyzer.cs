...
public sealed class Sst1154InvocationExpressionArgumentMustBeOnUniqueLinesAnalyzer : DiagnosticAnalyzer
{
    /// <summary>The unique diagnostic identifier for this analyzer.</summary>
    internal const string DiagnosticId = "SST1154";
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        UniqueLineRule.Register<InvocationExpressionSyntax>(
            context,
            Rule,
