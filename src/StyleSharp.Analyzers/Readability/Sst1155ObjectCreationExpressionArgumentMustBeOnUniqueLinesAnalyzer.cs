...
public sealed class Sst1155ObjectCreationExpressionArgumentMustBeOnUniqueLinesAnalyzer : DiagnosticAnalyzer
{
    /// <summary>The unique diagnostic identifier for this analyzer.</summary>
    internal const string DiagnosticId = "SST1155";
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        UniqueLineRule.Register<ObjectCreationExpressionSyntax>(
            context,
            Rule,
