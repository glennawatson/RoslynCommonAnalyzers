...
public sealed class Sst1157AttributeArgumentMustBeOnUniqueLinesAnalyzer : DiagnosticAnalyzer
{
    /// <summary>The unique diagnostic identifier for this analyzer.</summary>
    internal const string DiagnosticId = "SST1157";
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        UniqueLineRule.Register<AttributeSyntax>(
            context,
            Rule,
