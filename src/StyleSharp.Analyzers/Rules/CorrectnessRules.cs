...
internal static partial class CorrectnessRules
{
    ...
    /// <summary>
    /// Creates an enabled-by-default Info-severity Correctness descriptor — a correctness nudge where the code
    /// still compiles and runs, so a build-breaking Warning would be too strong.
    /// </summary>
    /// <param name="id">The diagnostic id.</param>
    /// <param name="title">The rule title.</param>
    /// <param name="messageFormat">The message format.</param>
