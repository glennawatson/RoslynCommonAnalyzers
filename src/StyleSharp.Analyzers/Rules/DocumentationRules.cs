...
internal static class DocumentationRules
{
    ...
    public static readonly DiagnosticDescriptor ExtensionBlockDocumentationReferenceMustMatch = Create(
        ...
        "Each <param> and <typeparam> element in an extension block's documentation refers to a name the block declares (the StyleSharp counterpart of Roslynator's RCS1263 for extension blocks).");
