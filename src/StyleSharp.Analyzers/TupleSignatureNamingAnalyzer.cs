...
/// the rule). A tuple type that appears inside a statement (a local) is a deliberately separate
/// case and is not reported; the check is purely syntactic.
/// </summary>
[DiagnosticAnalyzer(LanguageNames.CSharp)]
public sealed class TupleSignatureNamingAnalyzer : DiagnosticAnalyzer
{
    /// <inheritdoc/>
