...
/// <summary>CPU-profile benchmarks for regex-in-loop analysis.</summary>
[System.Diagnostics.DebuggerDisplay("CacheRegexOutsideLoopProfiledCpuBenchmarks: {Nodes}")]
[ShortRunJob]
[EventPipeProfiler(EventPipeProfile.CpuSampling)]
public class CacheRegexOutsideLoopProfiledCpuBenchmarks
{
    ...
    [GlobalSetup]
    public void Setup() => _state = CacheRegexOutsideLoopBenchmarkCases.Create(Nodes);
