...
/// <summary>Memory benchmarks for the completed-task-over-null code-fix path.</summary>
[System.Diagnostics.DebuggerDisplay("CompletedTaskOverNullCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class CompletedTaskOverNullCodeFixBenchmarks : IDisposable
{
    ...
    /// <summary>Benchmarks applying the completed-task-over-null code fix to one representative returned null.</summary>
