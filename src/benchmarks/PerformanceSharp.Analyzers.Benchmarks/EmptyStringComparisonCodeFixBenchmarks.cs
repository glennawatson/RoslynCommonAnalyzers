...
/// <summary>Memory benchmarks for the empty-string-comparison code-fix path.</summary>
[System.Diagnostics.DebuggerDisplay("EmptyStringComparisonCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class EmptyStringComparisonCodeFixBenchmarks : IDisposable
{
    ...
    {
        _workspace = new();
        _document = CodeFixBenchmarkDocumentFactory.CreateDocument(_workspace, EmptyStringComparisonBenchmarkSource.Generate(Nodes, violating: true));
    ...
    /// <summary>Benchmarks applying the empty-string-comparison code fix to one representative comparison.</summary>
    /// <returns>The updated document text length.</returns>
    [Benchmark]
    public async Task<int> EmptyStringComparison_ApplyFixAsync()
    {
        var updated = Psh1204EmptyStringComparisonCodeFixProvider.Apply(_document, _root, _comparison);
