...
/// <summary>Builds shared benchmark state for prefer-lock-type analysis.</summary>
internal static class PreferLockTypeBenchmarkCases
{
    ...
    public static SingleAnalyzerBenchmarkState Create(int nodes)
        => SingleAnalyzerBenchmarkHelper.Create(
            new Psh1300PreferLockTypeAnalyzer(),
