...
[System.Diagnostics.DebuggerDisplay("PreferLockTypeCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class PreferLockTypeCodeFixBenchmarks : IDisposable
{
    ...
    {
        var updated = TargetCodeFix.Apply(_document, _root, _field, Psh1300PreferLockTypeCodeFixProvider.Rewrite);
