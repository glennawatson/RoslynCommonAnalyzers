...
/// <summary>Memory benchmarks for the redundant-interpolated-string code-fix path.</summary>
[System.Diagnostics.DebuggerDisplay("RedundantInterpolatedStringCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class RedundantInterpolatedStringCodeFixBenchmarks : IDisposable
{
    ...
    /// <summary>Builds the benchmark document and selects one representative interpolated string.</summary>
    ...
    /// <summary>Benchmarks applying the redundant-interpolated-string code fix to one representative node.</summary>
