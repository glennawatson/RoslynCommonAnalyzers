...
/// <summary>Memory benchmarks for the redundant-params-array code-fix path.</summary>
[System.Diagnostics.DebuggerDisplay("RedundantParamsArrayCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class RedundantParamsArrayCodeFixBenchmarks : IDisposable
{
    ...
    /// <summary>The representative params call passed to the code fix.</summary>
    ...
    {
        _workspace = new();
        _document = CodeFixBenchmarkDocumentFactory.CreateDocument(_workspace, RedundantParamsArrayBenchmarkSource.Generate(Nodes, violating: true));
        ...
        _invocation = CodeFixBenchmarkSyntaxLookup.GetNthDescendant<InvocationExpressionSyntax>(
            ...
            static candidate => Psh1018RedundantParamsArrayAnalyzer.TryGetArrayArgument(candidate, out _));
    }
    ...
    /// <summary>Benchmarks applying the redundant-params-array code fix to one representative call.</summary>
    /// <returns>The updated document text length.</returns>
    [Benchmark]
    public async Task<int> RedundantParamsArray_ApplyFixAsync()
    {
        var updated = TargetCodeFix.Apply(_document, _root, _invocation, Psh1018RedundantParamsArrayCodeFixProvider.Rewrite);
