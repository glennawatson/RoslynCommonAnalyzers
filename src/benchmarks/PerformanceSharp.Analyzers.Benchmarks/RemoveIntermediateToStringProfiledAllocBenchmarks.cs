...
/// <summary>Allocation-profile benchmarks for intermediate ToString analysis.</summary>
[System.Diagnostics.DebuggerDisplay("RemoveIntermediateToStringProfiledAllocBenchmarks: {Nodes}")]
[ShortRunJob]
[EventPipeProfiler(EventPipeProfile.GcVerbose)]
public class RemoveIntermediateToStringProfiledAllocBenchmarks
{
    ...
    [GlobalSetup]
    public void Setup() => _state = RemoveIntermediateToStringBenchmarkCases.Create(Nodes);
