...
/// <summary>Builds synthetic source for single-probe insert analyzer benchmarks.</summary>
internal static class SingleProbeInsertBenchmarkSource
{
    /// <summary>Builds a compilation unit that exercises clean or violating single-probe insert patterns.</summary>
