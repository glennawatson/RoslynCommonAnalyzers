...
/// <summary>Memory benchmarks for the static-anonymous-function code-fix path.</summary>
[System.Diagnostics.DebuggerDisplay("StaticAnonymousFunctionCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class StaticAnonymousFunctionCodeFixBenchmarks : IDisposable
{
    ...
    /// <summary>The representative anonymous function passed to the code fix.</summary>
    private AnonymousFunctionExpressionSyntax _function = null!;
    ...
    /// <summary>Builds the benchmark document and selects one representative anonymous function.</summary>
    /// <returns>A task that represents the asynchronous setup operation.</returns>
    [GlobalSetup]
    public async Task SetupAsync()
    {
        _workspace = new();
        _document = CodeFixBenchmarkDocumentFactory.CreateDocument(_workspace, StaticAnonymousFunctionBenchmarkSource.Generate(Nodes, violating: true));
        ...
        _function = (AnonymousFunctionExpressionSyntax)method.ExpressionBody!.Expression;
    }
    ...
    /// <summary>Benchmarks applying the static-anonymous-function code fix to one representative function.</summary>
