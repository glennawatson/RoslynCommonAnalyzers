...
/// <summary>Memory benchmarks for the string-builder-append-char code-fix path.</summary>
[System.Diagnostics.DebuggerDisplay("StringBuilderAppendCharCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class StringBuilderAppendCharCodeFixBenchmarks : IDisposable
{
    ...
    {
        _workspace = new();
        _document = CodeFixBenchmarkDocumentFactory.CreateDocument(_workspace, StringBuilderAppendCharBenchmarkSource.Generate(Nodes, violating: true));
    ...
    /// <summary>Benchmarks applying the string-builder-append-char code fix to one representative literal.</summary>
