...
/// <summary>Memory benchmarks for the string-builder-inner-allocation code-fix path.</summary>
[System.Diagnostics.DebuggerDisplay("StringBuilderInnerAllocationCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class StringBuilderInnerAllocationCodeFixBenchmarks : IDisposable
{
    ...
    {
        _workspace = new();
        _document = CodeFixBenchmarkDocumentFactory.CreateDocument(_workspace, StringBuilderInnerAllocationBenchmarkSource.Generate(Nodes, violating: true));
    ...
    /// <summary>Benchmarks applying the string-builder-inner-allocation code fix to one representative invocation.</summary>
