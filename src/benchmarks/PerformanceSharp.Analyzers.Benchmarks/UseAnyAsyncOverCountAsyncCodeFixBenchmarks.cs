...
/// <summary>Memory benchmarks for the use-AnyAsync-over-CountAsync code-fix path.</summary>
[System.Diagnostics.DebuggerDisplay("UseAnyAsyncOverCountAsyncCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class UseAnyAsyncOverCountAsyncCodeFixBenchmarks : IDisposable
{
    ...
    {
        _workspace = new();
        _document = CodeFixBenchmarkDocumentFactory.CreateDocument(_workspace, UseAnyAsyncOverCountAsyncBenchmarkSource.Generate(Nodes, violating: true));
    ...
    /// <summary>Benchmarks applying the use-AnyAsync-over-CountAsync code fix to one representative comparison.</summary>
