...
/// <summary>Builds synthetic source for encoding decode analyzer benchmarks.</summary>
/// <remarks>
/// Every violating type carries exactly one PSH1225, and every clean type carries none, so the
/// diagnostic count for a corpus of N types is N and 0 respectively.
/// </remarks>
internal static class UseEncodingGetStringBenchmarkSource
{
    /// <summary>Builds a compilation unit that exercises clean or violating encoding decode code.</summary>
