...
/// <summary>Memory benchmarks for the linked-list end-property code-fix path.</summary>
[System.Diagnostics.DebuggerDisplay("UseLinkedListEndPropertyCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class UseLinkedListEndPropertyCodeFixBenchmarks : IDisposable
{
    ...
    /// <summary>The representative end-element call passed to the code fix.</summary>
    ...
    /// <summary>Builds the benchmark document and selects one representative call.</summary>
    /// <returns>A task that represents the asynchronous setup operation.</returns>
    [GlobalSetup]
    public async Task SetupAsync()
    {
        _workspace = new();
        _document = CodeFixBenchmarkDocumentFactory.CreateDocument(_workspace, UseLinkedListEndPropertyBenchmarkSource.Generate(Nodes, violating: true));
        ...
        _invocation = CodeFixBenchmarkSyntaxLookup.GetNthDescendant<InvocationExpressionSyntax>(
            ...
            Psh1124UseLinkedListEndPropertyAnalyzer.IsEndExtensionShape);
    }
    ...
    /// <summary>Benchmarks applying the linked-list end-property code fix to one representative call.</summary>
    /// <returns>The updated document text length.</returns>
    [Benchmark]
    public async Task<int> UseLinkedListEndProperty_ApplyFixAsync()
    {
        var updated = TargetCodeFix.Apply(_document, _root, _invocation, Psh1124UseLinkedListEndPropertyCodeFixProvider.Rewrite);
