...
/// <summary>Builds synthetic source for SearchValues analyzer benchmarks.</summary>
internal static class UseSearchValuesBenchmarkSource
{
    /// <summary>Builds a compilation unit that exercises clean or violating SearchValues patterns.</summary>
