...
/// <summary>CPU-profile benchmarks for state overload analysis.</summary>
[System.Diagnostics.DebuggerDisplay("UseStateOverloadProfiledCpuBenchmarks: {Nodes}")]
[ShortRunJob]
[EventPipeProfiler(EventPipeProfile.CpuSampling)]
public class UseStateOverloadProfiledCpuBenchmarks
{
    ...
    [GlobalSetup]
    public void Setup() => _state = UseStateOverloadBenchmarkCases.Create(Nodes);
