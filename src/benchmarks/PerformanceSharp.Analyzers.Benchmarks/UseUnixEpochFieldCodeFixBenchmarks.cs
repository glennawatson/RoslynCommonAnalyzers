...
/// <summary>Memory benchmarks for the unix-epoch code-fix path.</summary>
[System.Diagnostics.DebuggerDisplay("UseUnixEpochFieldCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class UseUnixEpochFieldCodeFixBenchmarks : IDisposable
{
    ...
    /// <summary>Benchmarks applying the unix-epoch code fix to one representative node.</summary>
