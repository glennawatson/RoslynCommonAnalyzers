...
/// <summary>Allocation-profile benchmarks for UTF-8 span property analysis.</summary>
[System.Diagnostics.DebuggerDisplay("Utf8SpanPropertyProfiledAllocBenchmarks: {Nodes}")]
[ShortRunJob]
[EventPipeProfiler(EventPipeProfile.GcVerbose)]
public class Utf8SpanPropertyProfiledAllocBenchmarks
{
    ...
    [GlobalSetup]
    public void Setup() => _state = Utf8SpanPropertyBenchmarkCases.Create(Nodes);
