...
public class AccessModifierCodeFixBenchmarks
{
    ...
    {
        var updated = await AccessModifierCodeFixProvider.AddAsync(_context.Document, _context.Node, Accessibility.Private, CancellationToken.None).ConfigureAwait(false);
