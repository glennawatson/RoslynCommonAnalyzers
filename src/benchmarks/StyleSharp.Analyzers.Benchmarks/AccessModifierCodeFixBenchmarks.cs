...
[System.Diagnostics.DebuggerDisplay("AccessModifierCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class AccessModifierCodeFixBenchmarks
{
    ...
    {
        var updated = await Sst1400AccessModifierCodeFixProvider.AddAsync(_context.Document, _context.Root, _context.Node, Accessibility.Private).ConfigureAwait(false);
