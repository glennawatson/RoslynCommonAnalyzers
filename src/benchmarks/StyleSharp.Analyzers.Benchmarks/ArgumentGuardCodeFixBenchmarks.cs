...
/// <summary>Memory benchmarks for the argument-guard code-fix path.</summary>
[System.Diagnostics.DebuggerDisplay("ArgumentGuardCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class ArgumentGuardCodeFixBenchmarks : IDisposable
{
    ...
    /// <summary>Builds the benchmark document and selects one representative guard clause.</summary>
    ...
    /// <summary>Benchmarks applying the argument-guard code fix to one representative guard clause.</summary>
