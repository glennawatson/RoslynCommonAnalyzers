...
/// <summary>Builds synthetic source for array-covariance analyzer benchmarks (SST2434).</summary>
internal static class ArrayCovarianceBenchmarkSource
{
    /// <summary>Builds a compilation unit that exercises clean or violating array conversions.</summary>
