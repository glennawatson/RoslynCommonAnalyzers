...
/// <summary>Memory benchmarks for the boolean-literal-comparison code-fix path.</summary>
[System.Diagnostics.DebuggerDisplay("BooleanLiteralComparisonCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class BooleanLiteralComparisonCodeFixBenchmarks : IDisposable
{
    ...
    /// <summary>The representative boolean comparison passed to the code fix.</summary>
    ...
    {
        _workspace = new();
        _document = CodeFixBenchmarkDocumentFactory.CreateDocument(_workspace, BooleanLiteralComparisonBenchmarkSource.Generate(Nodes, violating: true));
    ...
    /// <summary>Benchmarks applying the boolean-literal-comparison code fix to one representative node.</summary>
    /// <returns>The updated document text length.</returns>
    [Benchmark]
    public async Task<int> BooleanLiteralComparison_ApplyFixAsync()
    {
        var updated = TargetCodeFix.Apply(_document, _root, _comparison, Sst1143BooleanLiteralComparisonCodeFixProvider.Simplify);
