...
[System.Diagnostics.DebuggerDisplay("CollapseElseIntoElseIfCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class CollapseElseIntoElseIfCodeFixBenchmarks : IDisposable
{
    ...
    {
        var updated = ReplaceNodeCodeFix.Apply(_document, _root, _diagnostic, Sst1465CollapseElseIntoElseIfCodeFixProvider.TryRewrite);
