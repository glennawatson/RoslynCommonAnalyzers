...
[System.Diagnostics.DebuggerDisplay("CommentContentCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class CommentContentCodeFixBenchmarks
{
    ...
    /// <exception cref="InvalidOperationException"><paramref name="root"/> carries no single-line comment trivia at <paramref name="index"/>.</exception>
