...
/// <summary>CPU-profile (EventPipe) benchmarks for conditional-delegate-invocation analysis.</summary>
[System.Diagnostics.DebuggerDisplay("ConditionalDelegateInvocationProfiledCpuBenchmarks: {Nodes}")]
[EventPipeProfiler(EventPipeProfile.CpuSampling)]
[ShortRunJob]
public class ConditionalDelegateInvocationProfiledCpuBenchmarks
{
    ...
    [GlobalSetup]
    public void Setup() => _state = ConditionalDelegateInvocationBenchmarkCases.Create(Nodes);
