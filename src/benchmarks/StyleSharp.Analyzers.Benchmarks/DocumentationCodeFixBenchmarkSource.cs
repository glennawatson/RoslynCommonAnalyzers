...
internal static class DocumentationCodeFixBenchmarkSource
{
    ...
    internal static string GenerateFileHeader(int types) =>
        $$"""
           namespace Bench;
    ...
    /// <returns>The generated source text.</returns>
    internal static string GenerateDocumentationPeriod(int members) =>
        $$"""
           namespace Bench;
    ...
    /// <returns>The generated source text.</returns>
    internal static string GeneratePropertySummary(int members) =>
        $$"""
           namespace Bench;
    ...
    /// <param name="members">The number of synthetic properties to emit.</param>
    /// <returns>The generated source text.</returns>
    internal static string GenerateRestrictedPropertySummary(int members) =>
        $$"""
           namespace Bench;
    ...
    /// <param name="types">The number of synthetic types to emit.</param>
    /// <returns>The generated source text.</returns>
    internal static string GenerateConstructorSummary(int types) =>
        $$"""
           namespace Bench;
    ...
    /// <param name="types">The number of synthetic types to emit.</param>
    /// <returns>The generated source text.</returns>
    internal static string GenerateDestructorSummary(int types) =>
        $$"""
           namespace Bench;
    ...
    /// <param name="members">The number of synthetic members to emit.</param>
    /// <returns>The generated source text.</returns>
    internal static string GenerateDocumentationStub(int members) =>
        $$"""
           namespace Bench;
