...
/// <summary>Memory benchmarks for the seal-the-equatable-type code-fix path.</summary>
[System.Diagnostics.DebuggerDisplay("EquatableSealedCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class EquatableSealedCodeFixBenchmarks : IDisposable
{
    ...
    /// <summary>The representative class the code fix seals.</summary>
    ...
    /// <summary>Builds the benchmark document and selects one representative class.</summary>
    /// <returns>A task that represents the asynchronous setup operation.</returns>
    [GlobalSetup]
    public async Task SetupAsync()
    {
        _workspace = new();
        _document = CodeFixBenchmarkDocumentFactory.CreateDocument(_workspace, EquatableSealedBenchmarkSource.Generate(Nodes, violating: true));
    ...
    /// <summary>Benchmarks applying the seal-the-type code fix to one representative node.</summary>
