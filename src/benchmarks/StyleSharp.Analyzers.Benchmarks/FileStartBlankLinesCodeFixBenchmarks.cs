...
[System.Diagnostics.DebuggerDisplay("FileStartBlankLinesCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class FileStartBlankLinesCodeFixBenchmarks
{
    ...
    {
        var updated = await ExcessBlankLineCodeFixProvider.RemoveAsync(_context.Document, _context.Target, CancellationToken.None).ConfigureAwait(false);
