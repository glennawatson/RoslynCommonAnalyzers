...
public class LineScanBenchmarks
{
    ...
    [SuppressMessage(
        ...
        Justification = "This method is the baseline the optimized scan is measured against; its LINQ is the subject of the comparison, so removing it would leave nothing to compare.")]
