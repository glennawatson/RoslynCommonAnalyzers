...
/// <summary>Builds synthetic source for the literal-formatting analyzer benchmarks.</summary>
internal static class LiteralFormattingBenchmarkSource
{
    /// <summary>Builds a compilation unit of clean or violating numeric literals.</summary>
