...
/// <summary>Builds synthetic source for the malformed-placeholder benchmark (SST2441).</summary>
internal static class MalformedPlaceholderBenchmarkSource
{
    /// <summary>Builds a compilation unit that exercises clean or violating placeholders.</summary>
