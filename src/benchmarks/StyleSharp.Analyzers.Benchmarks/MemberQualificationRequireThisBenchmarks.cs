...
[System.Diagnostics.DebuggerDisplay("MemberQualificationRequireThisBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class MemberQualificationRequireThisBenchmarks
{
    ...
    private static readonly BenchmarkAnalyzerConfigOptionsProvider RequireThisOptions = new(
        ...
        new Dictionary<string, string> { [InstanceMemberQualificationKey] = "require_this", });
