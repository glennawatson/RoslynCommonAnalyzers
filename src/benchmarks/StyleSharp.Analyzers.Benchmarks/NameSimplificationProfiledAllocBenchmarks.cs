...
/// <summary>Allocation-profile benchmarks for shortest-equivalent-name analysis.</summary>
[System.Diagnostics.DebuggerDisplay("NameSimplificationProfiledAllocBenchmarks: {Nodes}")]
[ShortRunJob]
[EventPipeProfiler(EventPipeProfile.GcVerbose)]
public class NameSimplificationProfiledAllocBenchmarks
{
    ...
    [GlobalSetup]
    public void Setup() => _state = NameSimplificationBenchmarkCases.Create(Nodes);
    ...
    public Task<int> NameSimplification_HarnessBaseline() => SingleAnalyzerBenchmarkHelper.RunCompilerBaselineAsync(_state);
}
