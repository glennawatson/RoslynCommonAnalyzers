...
internal static class NamingBenchmarkCases
{
    ...
    internal static SingleAnalyzerBenchmarkState CreateParameter(int nodes) =>
    ...
    /// <returns>The prepared benchmark state.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static SingleAnalyzerBenchmarkState CreateLocalVariable(int nodes) =>
    ...
    /// <returns>The prepared benchmark state.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static SingleAnalyzerBenchmarkState CreateField(int nodes) =>
    ...
    /// <returns>The prepared benchmark state.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static SingleAnalyzerBenchmarkState CreateElement(int nodes) =>
