...
public class NewMemberReducesAccessibilityBenchmarks
{
    ...
    [GlobalSetup]
    public void Setup() => _state = SingleAnalyzerBenchmarkCases.Create(new Sst2462NewMemberReducesAccessibilityAnalyzer(), NewMemberReducesAccessibilityBenchmarkSource.Generate, Nodes);
