...
public class PrecedenceCodeFixBenchmarks : IDisposable
{
    ...
    /// <summary>Builds the benchmark document and selects one representative precedence expression.</summary>
    ...
    /// <summary>Benchmarks applying the precedence code fix to one representative node.</summary>
