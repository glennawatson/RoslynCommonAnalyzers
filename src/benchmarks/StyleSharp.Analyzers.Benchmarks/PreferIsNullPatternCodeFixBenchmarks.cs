...
/// <summary>Memory benchmarks for the prefer-is-null-pattern code-fix path.</summary>
[System.Diagnostics.DebuggerDisplay("PreferIsNullPatternCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class PreferIsNullPatternCodeFixBenchmarks : IDisposable
{
    ...
    /// <summary>The representative null comparison passed to the code fix.</summary>
    ...
    /// <summary>Builds the benchmark document and selects one representative null comparison.</summary>
    /// <returns>A task that represents the asynchronous setup operation.</returns>
    [GlobalSetup]
    public async Task SetupAsync()
    {
        _workspace = new();
        _document = CodeFixBenchmarkDocumentFactory.CreateDocument(_workspace, PreferIsNullPatternBenchmarkSource.Generate(Nodes, violating: true));
        ...
        _comparison = (BinaryExpressionSyntax)((ReturnStatementSyntax)method.Body!.Statements[0]).Expression!;
    }
    ...
    /// <summary>Benchmarks applying the prefer-is-null-pattern code fix to one representative node.</summary>
