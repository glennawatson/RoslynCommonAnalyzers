...
public class PreferSwitchExpressionCodeFixBenchmarks : IDisposable
{
    ...
    public async Task SetupAsync()
    {
        ...
        _diagnostic = Diagnostic.Create(ModernSyntaxRules.PreferSwitchExpression, switchStatement.SwitchKeyword.GetLocation());
    }
    ...
    /// <summary>Benchmarks applying one switch-expression code fix.</summary>
