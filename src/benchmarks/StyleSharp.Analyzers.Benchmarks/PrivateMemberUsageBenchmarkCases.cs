...
/// <summary>Builds shared benchmark state for private-member usage analysis.</summary>
internal static class PrivateMemberUsageBenchmarkCases
{
    ...
    public static SingleAnalyzerBenchmarkState Create(int types)
        => SingleAnalyzerBenchmarkCases.Create(
            new Sst1440PrivateMemberUsageAnalyzer(),
            PrivateMemberUsageBenchmarkSource.Generate,
            types);
}
