...
/// <summary>Memory benchmarks for the redundant-parentheses code-fix path.</summary>
[System.Diagnostics.DebuggerDisplay("RedundantParenthesesCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class RedundantParenthesesCodeFixBenchmarks : IDisposable
{
    ...
    /// <summary>Gets or sets a value indicating whether the benchmark should target attribute parentheses.</summary>
    [Params(false, true)]
    public bool AttributeShape { get; set; }

    /// <summary>Builds the benchmark document and selects one representative empty parenthesis list.</summary>
    ...
    /// <summary>Benchmarks applying the redundant-parentheses code fix to one representative node.</summary>
