...
/// <summary>Builds synthetic source for self-collection-operation analyzer benchmarks (SST2419).</summary>
internal static class SelfCollectionOperationBenchmarkSource
{
    /// <summary>Builds a compilation unit that exercises paired or self-applied collection calls.</summary>
