...
internal static class SemanticTypeBenchmarkCases
{
    ...
    internal static SingleAnalyzerBenchmarkState CreateTrivialAutoProperty(int nodes) =>
    ...
    /// <returns>The prepared benchmark state.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static SingleAnalyzerBenchmarkState CreateRedundantModifier(int nodes) =>
    ...
    /// <returns>The prepared benchmark state.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static SingleAnalyzerBenchmarkState CreateDefaultValueTypeConstructor(int nodes) =>
    ...
    /// <returns>The prepared benchmark state.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static SingleAnalyzerBenchmarkState CreateUseStringEmpty(int nodes) =>
    ...
    /// <returns>The prepared benchmark state.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static SingleAnalyzerBenchmarkState CreateUseNullableShorthand(int nodes) =>
    ...
    /// <returns>The prepared benchmark state.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static SingleAnalyzerBenchmarkState CreateUseTupleSyntax(int nodes) =>
    ...
    /// <returns>The prepared benchmark state.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static SingleAnalyzerBenchmarkState CreateDoNotPrefixWithBase(int nodes) =>
