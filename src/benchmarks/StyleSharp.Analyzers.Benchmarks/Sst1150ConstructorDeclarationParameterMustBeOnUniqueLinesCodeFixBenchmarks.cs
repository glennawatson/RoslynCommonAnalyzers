...
/// <summary>Memory benchmarks for the SST1150 code-fix path.</summary>
[System.Diagnostics.DebuggerDisplay("Sst1150ConstructorDeclarationParameterMustBeOnUniqueLinesCodeFixBenchmarks: {Members}")]
[MemoryDiagnoser]
[ShortRunJob]
public class Sst1150ConstructorDeclarationParameterMustBeOnUniqueLinesCodeFixBenchmarks
{
    /// <summary>Stores the prepared benchmark state for the current parameterized run.</summary>
    private UniqueLinesCodeFixBenchmarkContext<ConstructorDeclarationSyntax> _context = null!;
    ...
    public async Task SetupAsync() =>
        _context = await UniqueLinesCodeFixBenchmarkHelper.CreateAsync<ConstructorDeclarationSyntax>(
            Members,
            UniqueLinesCodeFixBenchmarkSource.GenerateConstructorDeclarationParameters).ConfigureAwait(false);
