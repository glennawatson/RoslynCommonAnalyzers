...
/// <summary>Memory benchmarks for the SST1156 code-fix path.</summary>
[System.Diagnostics.DebuggerDisplay("Sst1156ElementAccessExpressionArgumentMustBeOnUniqueLinesCodeFixBenchmarks: {Members}")]
[MemoryDiagnoser]
[ShortRunJob]
public class Sst1156ElementAccessExpressionArgumentMustBeOnUniqueLinesCodeFixBenchmarks
{
    /// <summary>Stores the prepared benchmark state for the current parameterized run.</summary>
    private UniqueLinesCodeFixBenchmarkContext<ElementAccessExpressionSyntax> _context = null!;
    ...
    public async Task SetupAsync() =>
        _context = await UniqueLinesCodeFixBenchmarkHelper.CreateAsync<ElementAccessExpressionSyntax>(
            Members,
            UniqueLinesCodeFixBenchmarkSource.GenerateElementAccessArguments).ConfigureAwait(false);
