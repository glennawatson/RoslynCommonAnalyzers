...
/// <summary>Memory benchmarks for the SST1159 code-fix path.</summary>
[System.Diagnostics.DebuggerDisplay("Sst1159ParenthesizedLambdaExpressionParameterMustBeOnUniqueLinesCodeFixBenchmarks: {Members}")]
[MemoryDiagnoser]
[ShortRunJob]
public class Sst1159ParenthesizedLambdaExpressionParameterMustBeOnUniqueLinesCodeFixBenchmarks
{
    /// <summary>Stores the prepared benchmark state for the current parameterized run.</summary>
    private UniqueLinesCodeFixBenchmarkContext<ParenthesizedLambdaExpressionSyntax> _context = null!;
    ...
    public async Task SetupAsync() =>
        _context = await UniqueLinesCodeFixBenchmarkHelper.CreateAsync<ParenthesizedLambdaExpressionSyntax>(
            Members,
            UniqueLinesCodeFixBenchmarkSource.GenerateParenthesizedLambdaExpressionParameters).ConfigureAwait(false);
