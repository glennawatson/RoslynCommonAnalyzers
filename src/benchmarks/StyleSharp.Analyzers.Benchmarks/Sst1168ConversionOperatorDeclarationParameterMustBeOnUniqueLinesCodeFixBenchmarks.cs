...
/// <summary>Memory benchmarks for the SST1168 code-fix path.</summary>
[System.Diagnostics.DebuggerDisplay("Sst1168ConversionOperatorDeclarationParameterMustBeOnUniqueLinesCodeFixBenchmarks: {Members}")]
[MemoryDiagnoser]
[ShortRunJob]
public class Sst1168ConversionOperatorDeclarationParameterMustBeOnUniqueLinesCodeFixBenchmarks
{
    /// <summary>Stores the prepared benchmark state for the current parameterized run.</summary>
    private UniqueLinesCodeFixBenchmarkContext<ConversionOperatorDeclarationSyntax> _context = null!;
    ...
    public async Task SetupAsync() =>
        _context = await UniqueLinesCodeFixBenchmarkHelper.CreateAsync<ConversionOperatorDeclarationSyntax>(
            Members,
            UniqueLinesCodeFixBenchmarkSource.GenerateConversionOperatorDeclarationParameters).ConfigureAwait(false);
