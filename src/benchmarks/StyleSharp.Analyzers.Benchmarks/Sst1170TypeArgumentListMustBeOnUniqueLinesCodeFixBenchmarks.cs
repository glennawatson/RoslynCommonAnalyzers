...
/// <summary>Memory benchmarks for the SST1170 code-fix path.</summary>
[System.Diagnostics.DebuggerDisplay("Sst1170TypeArgumentListMustBeOnUniqueLinesCodeFixBenchmarks: {Members}")]
[MemoryDiagnoser]
[ShortRunJob]
public class Sst1170TypeArgumentListMustBeOnUniqueLinesCodeFixBenchmarks
{
    /// <summary>Stores the prepared benchmark state for the current parameterized run.</summary>
    private UniqueLinesCodeFixBenchmarkContext<TypeArgumentListSyntax> _context = null!;
    ...
    public async Task SetupAsync() =>
        _context = await UniqueLinesCodeFixBenchmarkHelper.CreateAsync<TypeArgumentListSyntax>(
            Members,
            UniqueLinesCodeFixBenchmarkSource.GenerateTypeArgumentLists).ConfigureAwait(false);
