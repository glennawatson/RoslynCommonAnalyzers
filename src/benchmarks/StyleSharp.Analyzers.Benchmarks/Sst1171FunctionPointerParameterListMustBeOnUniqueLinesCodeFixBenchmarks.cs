...
/// <summary>Memory benchmarks for the SST1171 code-fix path.</summary>
[System.Diagnostics.DebuggerDisplay("Sst1171FunctionPointerParameterListMustBeOnUniqueLinesCodeFixBenchmarks: {Members}")]
[MemoryDiagnoser]
[ShortRunJob]
public class Sst1171FunctionPointerParameterListMustBeOnUniqueLinesCodeFixBenchmarks
{
    /// <summary>Stores the prepared benchmark state for the current parameterized run.</summary>
    private UniqueLinesCodeFixBenchmarkContext<FunctionPointerParameterListSyntax> _context = null!;
    ...
    public async Task SetupAsync() =>
        _context = await UniqueLinesCodeFixBenchmarkHelper.CreateAsync<FunctionPointerParameterListSyntax>(
            Members,
            UniqueLinesCodeFixBenchmarkSource.GenerateFunctionPointerParameterLists,
            allowUnsafe: true).ConfigureAwait(false);
