...
/// <summary>Builds synthetic source for static-initializer-reads-later-field analyzer benchmarks (SST2428).</summary>
internal static class StaticInitializerReadsLaterFieldBenchmarkSource
{
    /// <summary>Builds a compilation unit that exercises clean or violating static field initializers.</summary>
