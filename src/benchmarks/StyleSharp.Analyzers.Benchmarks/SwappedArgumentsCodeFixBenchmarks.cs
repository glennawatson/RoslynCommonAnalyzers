...
public class SwappedArgumentsCodeFixBenchmarks : IDisposable
{
    ...
    /// <summary>The position the reported argument belongs in.</summary>
    private const string PartnerPosition = "1";
    ...
    /// <summary>Benchmarks applying the swapped-argument code fix to one representative call.</summary>
