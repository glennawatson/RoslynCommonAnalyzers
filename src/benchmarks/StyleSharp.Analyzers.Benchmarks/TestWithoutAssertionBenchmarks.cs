...
public class TestWithoutAssertionBenchmarks
{
    ...
    [GlobalSetup]
    public void Setup() => _state = SingleAnalyzerBenchmarkCases.Create(new Sst2500TestWithoutAssertionAnalyzer(), TestWithoutAssertionBenchmarkSource.Generate, Nodes);
