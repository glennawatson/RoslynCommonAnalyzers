...
internal static class UniqueLinesCodeFixBenchmarkSource
{
    ...
    /// <summary>The brace that opens a member body in the generated source, at member indentation.</summary>
    private const string MemberBodyOpenBrace = "    {";

    /// <summary>The brace that closes a member body in the generated source, at member indentation.</summary>
    ...
    internal static string GenerateConstructorDeclarationParameters(int members) =>
        $$"""
           namespace Bench;
    ...
    internal static string GenerateMethodDeclarationParameters(int members) =>
    ...
    /// <param name="members">The number of synthetic declarations to emit.</param>
    /// <returns>The generated source text.</returns>
    internal static string GenerateDelegateDeclarationParameters(int members) =>
        $$"""
           namespace Bench;
    ...
    /// <returns>The generated source text.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static string GenerateIndexerDeclarationParameters(int members) =>
    ...
    /// <returns>The generated source text.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static string GenerateInvocationArguments(int members) =>
    ...
    /// <returns>The generated source text.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static string GenerateObjectCreationArguments(int members) =>
    ...
    /// <param name="members">The number of synthetic members to emit.</param>
    /// <returns>The generated source text.</returns>
    internal static string GenerateElementAccessArguments(int members) =>
        $$"""
           namespace Bench;
    ...
    /// <param name="members">The number of synthetic declarations to emit.</param>
    /// <returns>The generated source text.</returns>
    internal static string GenerateAttributeArguments(int members) =>
        $$"""
           namespace Bench;
    ...
    /// <returns>The generated source text.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static string GenerateAnonymousMethodExpressionParameters(int members) =>
    ...
    /// <returns>The generated source text.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static string GenerateParenthesizedLambdaExpressionParameters(int members) =>
        GenerateDistributedLambdaLikeMembers(
            members,
    ...
    /// <param name="members">The number of synthetic declarations to emit.</param>
    /// <returns>The generated source text.</returns>
    internal static string GenerateRecordDeclarationParameters(int members) =>
        $$"""
           namespace Bench;
    ...
    /// <param name="members">The number of synthetic declarations to emit.</param>
    /// <returns>The generated source text.</returns>
    internal static string GenerateClassDeclarationParameters(int members) =>
        $$"""
           namespace Bench;
    ...
    /// <param name="members">The number of synthetic declarations to emit.</param>
    /// <returns>The generated source text.</returns>
    internal static string GenerateStructDeclarationParameters(int members) =>
        $$"""
           namespace Bench;
    ...
    /// <returns>The generated source text.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static string GenerateImplicitObjectCreationArguments(int members) =>
        GenerateDistributedMemberContainers(
            members,
    ...
    /// <returns>The generated source text.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static string GenerateConstructorInitializerArguments(int members) =>
    ...
    /// <param name="members">The number of synthetic declarations to emit.</param>
    /// <returns>The generated source text.</returns>
    internal static string GeneratePrimaryConstructorBaseTypeArguments(int members) =>
        $$"""
           namespace Bench;
    ...
    /// <returns>The generated source text.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static string GenerateLocalFunctionStatementParameters(int members) =>
        GenerateDistributedMemberContainers(
            members,
    ...
    /// <param name="members">The number of synthetic declarations to emit.</param>
    /// <returns>The generated source text.</returns>
    internal static string GenerateOperatorDeclarationParameters(int members) =>
        $$"""
           namespace Bench;
    ...
    /// <param name="members">The number of synthetic declarations to emit.</param>
    /// <returns>The generated source text.</returns>
    internal static string GenerateConversionOperatorDeclarationParameters(int members) =>
        $$"""
           namespace Bench;
    ...
    /// <param name="members">The number of synthetic declarations to emit.</param>
    /// <returns>The generated source text.</returns>
    internal static string GenerateTypeParameterLists(int members) =>
        $$"""
           namespace Bench;
    ...
    /// <returns>The generated source text.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static string GenerateTypeArgumentLists(int members) =>
    ...
    /// <param name="members">The number of synthetic declarations to emit.</param>
    /// <returns>The generated source text.</returns>
    internal static string GenerateFunctionPointerParameterLists(int members) =>
        $$"""
           namespace Bench;
        ...
        Action<System.Text.StringBuilder>? appendPreamble = null)
    {
        ...
        {
            _ = builder.Append("internal static class ")
    ...
    private static string GenerateDistributedTypeNamespaces(int members, Func<int, string> buildType)
    {
        ...
        while (memberIndex < members)
        {
            _ = builder.Append("namespace Bench.Group")
            ...
            for (var i = 0; i < namespaceMemberCount; i++)
            {
                ...
                _ = builder.Append(buildType(memberIndex + i));
            }
    ...
    /// <param name="builder">The destination source builder.</param>
    private static void AppendImplicitObjectCreationPreamble(System.Text.StringBuilder builder) => _ = builder.AppendLine("    private sealed class Item")
            .AppendLine(MemberBodyOpenBrace)
            .AppendLine("        public Item(int x, int y, int z)")
            .AppendLine("        {")
            .AppendLine("        }")
            .Append(MemberBodyCloseBrace);
    ...
    /// <param name="builder">The destination source builder.</param>
    /// <param name="index">The synthetic member index.</param>
    private static void AppendAnonymousMethodExpressionMember(System.Text.StringBuilder builder, int index) => _ = builder.Append("    internal static System.Action<int, int, int> M")
            .Append(index)
            .AppendLine("()")
            .AppendLine(MemberBodyOpenBrace)
    ...
    /// <param name="builder">The destination source builder.</param>
    /// <param name="index">The synthetic member index.</param>
    private static void AppendParenthesizedLambdaExpressionMember(System.Text.StringBuilder builder, int index) => _ = builder.Append("    internal static System.Func<int, int, int, int> M")
            .Append(index)
            .AppendLine("()")
            .AppendLine(MemberBodyOpenBrace)
