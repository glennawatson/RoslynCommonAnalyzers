...
/// <summary>Memory benchmarks for unwrap-else-after-jump code fixes.</summary>
[System.Diagnostics.DebuggerDisplay("UnwrapElseAfterJumpCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class UnwrapElseAfterJumpCodeFixBenchmarks : IDisposable
{
    ...
    {
        _workspace = new();
        _document = CodeFixBenchmarkDocumentFactory.CreateDocument(_workspace, UnwrapElseAfterJumpBenchmarkSource.Generate(Nodes, violating: true));
        ...
        _diagnostic = Diagnostic.Create(MaintainabilityRules.UnwrapElseAfterJump, elseClause.ElseKeyword.GetLocation());
    }
    ...
    /// <summary>Benchmarks applying one unwrap-else code fix.</summary>
    /// <returns>The updated document text length.</returns>
    [Benchmark]
    public async Task<int> UnwrapElseAfterJump_ApplyFixAsync()
    {
        var updated = Sst1464UnwrapElseAfterJumpCodeFixProvider.Apply(_document, _root, _diagnostic);
