...
/// <summary>Builds synthetic source for numeric-literal-suffix analysis.</summary>
internal static class UppercaseLiteralSuffixBenchmarkSource
{
    /// <summary>Builds clean or violating numeric literal members.</summary>
    ...
    public static string Generate(int members, bool violating)
        => $$"""
           ...
           internal sealed class UppercaseLiteralSuffixBench
           {
    ...
    private static string GenerateMember(int index, bool violating)
        => violating
            ? $$"""
                public long Value{{index}}() => {{index}}l;
                """
            : $$"""
                public long Value{{index}}() => {{index}}L;
                """;
