...
[System.Diagnostics.DebuggerDisplay("UseLiteralSuffixCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class UseLiteralSuffixCodeFixBenchmarks : IDisposable
{
    ...
    /// <summary>Builds the benchmark document and selects one representative casted literal.</summary>
    ...
    /// <summary>Benchmarks applying the literal-suffix code fix to one representative node.</summary>
