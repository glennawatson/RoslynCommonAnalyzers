...
[System.Diagnostics.DebuggerDisplay("UseReadableConditionsCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class UseReadableConditionsCodeFixBenchmarks : IDisposable
{
    ...
    /// <summary>Benchmarks applying the readable-conditions code fix to one representative node.</summary>
