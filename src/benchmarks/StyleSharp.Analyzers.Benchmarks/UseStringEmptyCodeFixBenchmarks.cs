...
[System.Diagnostics.DebuggerDisplay("UseStringEmptyCodeFixBenchmarks: {Nodes}")]
[MemoryDiagnoser]
[ShortRunJob]
public class UseStringEmptyCodeFixBenchmarks : IDisposable
{
    ...
    /// <summary>Builds the benchmark document and selects one representative string literal.</summary>
    ...
    /// <summary>Benchmarks applying the string-empty code fix to one representative node.</summary>
