...
/// <summary>Builds synthetic source for condition-only-loop analysis.</summary>
internal static class UseWhileOverForBenchmarkSource
{
    /// <summary>Builds clean or violating loop members.</summary>
