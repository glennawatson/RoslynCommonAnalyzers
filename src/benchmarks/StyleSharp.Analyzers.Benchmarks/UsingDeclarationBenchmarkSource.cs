...
/// <summary>Builds synthetic source for using-declaration analysis.</summary>
internal static class UsingDeclarationBenchmarkSource
{
    /// <summary>Builds clean or violating using blocks.</summary>
    /// <param name="members">The number of synthetic members to emit.</param>
    /// <param name="violating">Whether to emit tail-position using blocks.</param>
    ...
    public static string Generate(int members, bool violating)
        => $$"""
           ...
           internal sealed class UsingDeclarationBench
           {
