...
public class AvoidDoubleLookupAnalyzerUnitTest
{
    ...
    {
        var test = new VerifyDoubleLookup.Test { ReferenceAssemblies = ReferenceAssemblies.Net.Net90, TestCode = source, FixedCode = fixedSource };
    ...
    {
        var test = new VerifyDoubleLookup.Test { ReferenceAssemblies = ReferenceAssemblies.Net.Net90, TestCode = source, FixedCode = source };
