...
public class CollectionNativeMethodCodeFixProviderTests
{
    ...
    public async Task PredicateShapeControlsEditsAsync(string expression, string? target, bool membership, string? expected)
    {
        ...
        var direct = ReplaceNodeCodeFix.Apply(document, root, diagnostic, CollectionNativeMethodCodeFixProvider.CreateEdit);
        ...
        BatchEditRegistration.Register<CollectionNativeMethodCodeFixProvider>(editor, diagnostic);
