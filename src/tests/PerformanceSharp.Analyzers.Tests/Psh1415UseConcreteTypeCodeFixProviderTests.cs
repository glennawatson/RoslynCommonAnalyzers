...
public class Psh1415UseConcreteTypeCodeFixProviderTests
{
    ...
    public async Task DeclarationShapeControlsEditsAsync(string statement, string? expected)
    {
        ...
        BatchEditRegistration.Register<Psh1415UseConcreteTypeCodeFixProvider>(editor, diagnostic);
        var changed = ReplaceNodeCodeFix.Apply(document, root, model, diagnostic, Psh1415UseConcreteTypeCodeFixProvider.TryRewrite);
