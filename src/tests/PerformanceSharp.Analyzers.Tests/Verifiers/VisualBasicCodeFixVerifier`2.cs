...
/// <summary>Provides helpers for verifying the behaviour of a Visual Basic <see cref="DiagnosticAnalyzer"/> and its associated <see cref="CodeFixProvider"/> in tests.</summary>
