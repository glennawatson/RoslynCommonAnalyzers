...
/// package's configurable rules (rule-specific <c>securitysharp.&lt;RuleId&gt;.&lt;option&gt;</c> then
/// project-wide <c>securitysharp.&lt;option&gt;</c>).
/// </summary>
public class AnalyzerOptionReaderUnitTest
{
    /// <summary>A rule-specific key used by the tests.</summary>
    private const string RuleKey = "securitysharp.SES0000.example";

    /// <summary>A project-wide key used by the tests.</summary>
    private const string GeneralKey = "securitysharp.example";
