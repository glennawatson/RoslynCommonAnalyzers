...
public class Pbkdf2IterationCountAnalyzerUnitTest
{
    ...
    [Test]
    public Task LowLiteralIterationsReportedAsync() =>
        VerifyNet90Async(
            """
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task NamedLowIterationsReportedAsync() =>
        VerifyNet90Async(
            """
            using System.Security.Cryptography;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task ConstFieldLowIterationsReportedAsync() =>
        VerifyNet90Async(
            """
            using System.Security.Cryptography;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task SpanOverloadLowIterationsReportedAsync() =>
        VerifyNet90Async(
            """
            using System;
            using System.Security.Cryptography;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task AtFloorIterationsCleanAsync() =>
        VerifyNet90Async(
            """
            using System.Security.Cryptography;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task AboveFloorIterationsCleanAsync() =>
        VerifyNet90Async(
            """
            using System.Security.Cryptography;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task NonConstantIterationsCleanAsync() =>
        VerifyNet90Async(
            """
            using System.Security.Cryptography;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task ConfigDrivenIterationsCleanAsync() =>
        VerifyNet90Async(
            """
            using System.Security.Cryptography;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task UnrelatedPbkdf2MethodCleanAsync() =>
        VerifyNet90Async(
            """
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task ConstructorLowIterationsNotReportedAsync() =>
        VerifyNet90Async(
            """
            using System.Security.Cryptography;
    ...
    public async Task SilentWhenPbkdf2UnavailableAsync()
    {
        ...
        var test = new AnalyzePbkdf2.Test { ReferenceAssemblies = ReferenceAssemblies.NetFramework.Net472.Default, TestCode = Source };
    ...
    {
        var test = new AnalyzePbkdf2.Test { ReferenceAssemblies = ReferenceAssemblies.Net.Net90, TestCode = source };
