...
public class EnumNamingAnalyzerUnitTest
{
    ...
    [Test]
    public Task PascalCaseAsync() => Verify.VerifyAnalyzerAsync("public enum LogLevel { Debug, Info }");

    /// <summary>Verifies a two-letter acronym stays upper-case, as the .NET guidelines have it.</summary>
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task TwoLetterAcronymAsync() => Verify.VerifyAnalyzerAsync("public enum IOMode { Read, Write }");

    /// <summary>Verifies a two-letter acronym is allowed at the end of the name.</summary>
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task TrailingTwoLetterAcronymAsync() => Verify.VerifyAnalyzerAsync("public enum XY { A, B }");

    /// <summary>Verifies a digit inside the name is not mistaken for a violation.</summary>
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task DigitAsync() => Verify.VerifyAnalyzerAsync("public enum Http2Client { A, B }");

    /// <summary>Verifies a single-letter name is left alone; it is already PascalCase.</summary>
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task SingleLetterAsync() => Verify.VerifyAnalyzerAsync("public enum A { X, Y }");

    /// <summary>Verifies a lower-case enum name is left to SST1300, which owns the first character.</summary>
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task LowerCaseIsLeftToElementNamingAsync() =>
        Verify.VerifyAnalyzerAsync("public enum lowercase { A, B }");

    /// <summary>Verifies a lower-case snake_case name is also SST1300's, so the two rules never double up.</summary>
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task LowerCaseWithUnderscoreIsLeftToElementNamingAsync() =>
        Verify.VerifyAnalyzerAsync("public enum log_level { A, B }");

    /// <summary>Verifies an underscore is reported once the name starts upper-case, and the fix removes it.</summary>
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task UnderscoreAfterUpperCaseAsync() =>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task TrailingUnderscoreAsync() =>
        Verify.VerifyCodeFixAsync(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task LeadingAcronymAsync() =>
        Verify.VerifyCodeFixAsync(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task LeadingAcronymFollowedByWordsAsync() =>
        Verify.VerifyCodeFixAsync(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task TrailingAcronymAsync() =>
        Verify.VerifyCodeFixAsync(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task LongRunBeforeWordAsync() =>
        Verify.VerifyCodeFixAsync(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task MembersAreNotReportedAsync() =>
        Verify.VerifyAnalyzerAsync("public enum Good { lower_case, ALSOBAD }");
}
