...
public class FileHeaderAnalyzerUnitTest
{
    ...
    /// <summary>The diagnostic id under test.</summary>
    private const string FileHeaderDiagnosticId = "SST1633";

    /// <summary>A source file that already carries the configured header.</summary>
    ...
    [Test]
    public Task UnsetIgnoredAsync() =>
        Verify.VerifyAnalyzerAsync("namespace N { }");
    ...
    {
        var test = new Verify.Test { TestCode = SourceWithExpectedHeader };
