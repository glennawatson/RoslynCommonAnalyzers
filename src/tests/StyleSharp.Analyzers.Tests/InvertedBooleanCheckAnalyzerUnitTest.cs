...
public class InvertedBooleanCheckAnalyzerUnitTest
{
    ...
    [Test]
    public Task RelationalInversionOnNullableIsCleanAsync() =>
        VerifyInverted.VerifyAnalyzerAsync(
            """
            public class C
            {
                public bool M(int? a, int? b) => !(a < b);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task RelationalInversionOnFloatingPointIsCleanAsync() =>
        VerifyInverted.VerifyAnalyzerAsync(
            """
            public class C
            {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task NonComparisonNegationIsCleanAsync() =>
        VerifyInverted.VerifyAnalyzerAsync(
            """
            public class C
            {
