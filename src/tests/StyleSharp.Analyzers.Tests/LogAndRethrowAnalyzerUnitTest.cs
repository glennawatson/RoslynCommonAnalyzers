...
{
    /// <summary>Source whose catches log the caught exception on a logger-typed receiver and then rethrow.</summary>
    private const string LoggerReceiverCatchesSource = """
        #nullable enable
    ...
    /// <summary>Source whose catches pass the caught exception to a log-named callee reached without a logger-typed receiver.</summary>
    private const string ExceptionPassedCatchesSource = """
        #nullable enable
    ...
    /// <summary>Source holding the catch shapes a neighbouring rule owns, alongside catches that genuinely handle.</summary>
    private const string AdjacentCatchShapesSource = """
        #nullable enable
    ...
    public Task LoggerReceiverShapesAreReportedAsync() =>
        VerifyLogAndRethrow.VerifyAnalyzerAsync(LoggerReceiverCatchesSource);
    ...
    public Task ExceptionPassedRoutesAreReportedAsync() =>
        VerifyLogAndRethrow.VerifyAnalyzerAsync(ExceptionPassedCatchesSource);
    ...
    public Task AdjacentShapesAreCleanAsync() =>
        VerifyLogAndRethrow.VerifyAnalyzerAsync(AdjacentCatchShapesSource);
