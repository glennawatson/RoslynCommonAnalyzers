...
using Verifysst0001 = StyleSharp.Analyzers.Tests.CSharpCodeFixVerifier<
    StyleSharp.Analyzers.Sst1150ConstructorDeclarationParameterMustBeOnUniqueLinesAnalyzer,
    StyleSharp.Analyzers.Sst1150ConstructorDeclarationParameterMustBeOnUniqueLinesCodeFixProvider>;

namespace StyleSharp.Analyzers.Tests;

/// <summary>Unit tests for the SST1150 analyzer that requires constructor declarations to keep their parameters on unique lines.</summary>
public class Sst1150ConstructorDeclarationAnalyzersUnitTest
{
    ...
    public async Task InvalidJaggedEntryAsync(int number)
    {
        ...
        await Verifysst0001.VerifyAnalyzerAsync(test, Verifysst0001.Diagnostic("SST1150").WithSpan(startLine, startColumn, endLine, endColumn));
    }
    ...
    public async Task ValidCodeFixAsync(int number)
    {
        ...
        var expected = Verifysst0001.Diagnostic("SST1150").WithSpan(startLine, startColumn, endLine, endColumn);
