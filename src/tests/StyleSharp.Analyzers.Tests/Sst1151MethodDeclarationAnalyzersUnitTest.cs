...
using Verifysst0002 = StyleSharp.Analyzers.Tests.CSharpCodeFixVerifier<
    StyleSharp.Analyzers.Sst1151MethodDeclarationParameterMustBeOnUniqueLinesAnalyzer,
    StyleSharp.Analyzers.Sst1151MethodDeclarationParameterMustBeOnUniqueLinesCodeFixProvider>;

namespace StyleSharp.Analyzers.Tests;

/// <summary>Unit tests for the SST1151 analyzer that requires method declarations to keep their parameters on unique lines.</summary>
public class Sst1151MethodDeclarationAnalyzersUnitTest
{
    ...
    public async Task InvalidJaggedEntryAsync(int number)
    {
        ...
        await Verifysst0002.VerifyAnalyzerAsync(test, Verifysst0002.Diagnostic("SST1151").WithSpan(startLine, startColumn, endLine, endColumn));
    }
    ...
    public async Task ValidCodeFixAsync(int number)
    {
        ...
        var expected = Verifysst0002.Diagnostic("SST1151").WithSpan(startLine, startColumn, endLine, endColumn);
