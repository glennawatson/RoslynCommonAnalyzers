...
using Verifysst0004 = StyleSharp.Analyzers.Tests.CSharpCodeFixVerifier<
    StyleSharp.Analyzers.Sst1153IndexerDeclarationParameterMustBeOnUniqueLinesAnalyzer,
    StyleSharp.Analyzers.Sst1153IndexerDeclarationParameterMustBeOnUniqueLinesCodeFixProvider>;

namespace StyleSharp.Analyzers.Tests;

/// <summary>Unit tests for the SST1153 analyzer that requires indexer declarations to keep their parameters on unique lines.</summary>
public class Sst1153IndexerDeclarationAnalyzersUnitTest
{
    ...
    public async Task EmptyAsync()
    {
        ...
        await Verifysst0004.VerifyAnalyzerAsync(test);
    }
    ...
    public async Task InvalidJaggedEntryAsync(int number)
    {
        ...
        await Verifysst0004.VerifyAnalyzerAsync(test, Verifysst0004.Diagnostic("SST1153").WithSpan(startLine, startColumn, endLine, endColumn));
    }
    ...
    public async Task ValidCodeFixAsync(int number)
    {
        ...
        var expected = Verifysst0004.Diagnostic("SST1153").WithSpan(startLine, startColumn, endLine, endColumn);
    ...
    private static (string Text, int StartLine, int StartColumn, int EndLine, int EndColumn) GenerateJagged(int number)
    {
        var classGenerator = new ClassGeneratorBuilder();
        classGenerator.Init();
        var (startLine, startColumn, endLine, endColumn) = classGenerator.IndexerDeclarationJagged(number);
