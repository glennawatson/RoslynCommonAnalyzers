...
using Verifysst0006 = StyleSharp.Analyzers.Tests.CSharpCodeFixVerifier<
    StyleSharp.Analyzers.Sst1155ObjectCreationExpressionArgumentMustBeOnUniqueLinesAnalyzer,
    StyleSharp.Analyzers.Sst1155ObjectCreationExpressionArgumentMustBeOnUniqueLinesCodeFixProvider>;

namespace StyleSharp.Analyzers.Tests;

/// <summary>Unit tests for the SST1155 analyzer that requires object-creation expressions to keep their parameters on unique lines.</summary>
public class Sst1155ObjectCreationExpressionAnalyzersUnitTest
{
    ...
    public async Task InvalidJaggedEntryAsync(int number)
    {
        ...
        await Verifysst0006.VerifyAnalyzerAsync(test, Verifysst0006.Diagnostic("SST1155").WithSpan(startLine, startColumn, endLine, endColumn));
    }
    ...
    public async Task ValidCodeFixAsync(int number)
    {
        ...
        var expected = Verifysst0006.Diagnostic("SST1155").WithSpan(startLine, startColumn, endLine, endColumn);
