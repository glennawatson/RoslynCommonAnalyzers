...
using Verifysst0010 = StyleSharp.Analyzers.Tests.CSharpCodeFixVerifier<
    StyleSharp.Analyzers.Sst1159ParenthesizedLambdaExpressionParameterMustBeOnUniqueLinesAnalyzer,
    StyleSharp.Analyzers.Sst1159ParenthesizedLambdaExpressionParameterMustBeOnUniqueLinesCodeFixProvider>;

namespace StyleSharp.Analyzers.Tests;

/// <summary>Unit tests for the SST1159 analyzer that requires parenthesized lambda expressions to keep their parameters on unique lines.</summary>
public class Sst1159ParenthesizedLambdaExpressionAnalyzersUnitTest
{
    ...
    public async Task InvalidJaggedEntryAsync(int number)
    {
        ...
        await Verifysst0010.VerifyAnalyzerAsync(test, Verifysst0010.Diagnostic("SST1159").WithSpan(startLine, startColumn, endLine, endColumn));
    }
    ...
    public async Task ValidCodeFixAsync(int number)
    {
        ...
        var expected = Verifysst0010.Diagnostic("SST1159").WithSpan(startLine, startColumn, endLine, endColumn);
