...
using Verifysst0011 = StyleSharp.Analyzers.Tests.CSharpCodeFixVerifier<
    StyleSharp.Analyzers.Sst1160RecordDeclarationParameterMustBeOnUniqueLinesAnalyzer,
    StyleSharp.Analyzers.Sst1160RecordDeclarationParameterMustBeOnUniqueLinesCodeFixProvider>;

namespace StyleSharp.Analyzers.Tests;

/// <summary>Unit tests for the SST1160 analyzer that requires record declaration parameters to be on unique lines.</summary>
public class Sst1160RecordDeclarationAnalyzersUnitTest
{
