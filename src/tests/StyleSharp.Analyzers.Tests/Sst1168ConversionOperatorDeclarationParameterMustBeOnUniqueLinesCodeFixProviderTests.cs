...
public class Sst1168ConversionOperatorDeclarationParameterMustBeOnUniqueLinesCodeFixProviderTests
{
    ...
    public async Task IncompleteConversionParametersAreSplitAsync()
    {
        ...
        var direct = await Sst1168ConversionOperatorDeclarationParameterMustBeOnUniqueLinesCodeFixProvider.Fix.FixAsync(document, root, conversion);
        var editor = await DocumentEditor.CreateAsync(document);
        BatchEditRegistration.Register<Sst1168ConversionOperatorDeclarationParameterMustBeOnUniqueLinesCodeFixProvider>(editor, diagnostic);
