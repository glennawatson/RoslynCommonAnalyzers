...
public class Sst2491AwaitableReturnedFromTeardownCodeFixProviderTests
{
    ...
    public async Task OwnedReturnsAreAwaitedAsync(string source, string expected)
    {
        ...
        await Assert.That(Sst2491AwaitableReturnedFromTeardownCodeFixProvider.TryGetBatchEditSpan(root, diagnostic, out var span)).IsTrue();
        ...
        BatchEditRegistration.Register<Sst2491AwaitableReturnedFromTeardownCodeFixProvider>(editor, diagnostic);
    ...
    public async Task UnsupportedReturnHasNoFixAsync(string source, bool hasFunctionSpan)
    {
        ...
        await Assert.That(Sst2491AwaitableReturnedFromTeardownCodeFixProvider.TryGetBatchEditSpan(root, diagnostic, out var span)).IsEqualTo(hasFunctionSpan);
