...
public class Sst2499ProcessExitStatusAnalyzerUnitTest
{
    ...
    [Test]
    public async Task ExitCodeAfterWaitReportedAsync()
        => await RunAsync(
            """
    ...
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [Test]
    public async Task ExitCodeAfterAsyncWaitReportedAsync()
        => await RunAsync(
            """
            using System.Diagnostics;
    ...
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [Test]
    public async Task ExitCodeWithoutWaitIsCleanAsync()
        => await RunAsync(
            """
            using System.Diagnostics;
    ...
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [Test]
    public async Task UnrelatedExitCodeIsCleanAsync()
        => await RunAsync(
            """
            public class Job
            {
    ...
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [Test]
    public async Task WithoutReplacementApiIsCleanAsync()
        => await RunAsync(
            """
            using System.Diagnostics;
    ...
    {
        var test = new VerifyExitStatus.Test
        {
