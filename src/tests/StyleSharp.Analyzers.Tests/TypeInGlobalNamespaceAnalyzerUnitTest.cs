...
public class TypeInGlobalNamespaceAnalyzerUnitTest
{
    ...
    public async Task TypeOutsideAnyNamespaceIsReportedAsync()
    {
        ...
        var test = new VerifyGlobalNamespace.Test { ReferenceAssemblies = ReferenceAssemblies.Net.Net80, TestCode = Source, };
    ...
    [Test]
    public Task EveryPartialPartIsReportedAsync() =>
        VerifyGlobalNamespace.VerifyAnalyzerAsync(
            """
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task GlobalDelegateIsCleanAsync() =>
        VerifyGlobalNamespace.VerifyAnalyzerAsync("public delegate void Handler(int value);");
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task NamespacedTypeIsCleanAsync() =>
        VerifyGlobalNamespace.VerifyAnalyzerAsync(
            """
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task FileScopedNamespaceIsCleanAsync() =>
        VerifyGlobalNamespace.VerifyAnalyzerAsync(
            """
            namespace Vendor.Widgets;
    ...
    public async Task TopLevelStatementsProgramIsCleanAsync()
    {
        ...
        {
            TestState = { OutputKind = OutputKind.ConsoleApplication, Sources = { ("Main.cs", "System.Console.WriteLine(\"running\");"), ("Program.cs", "public partial class Program;"), }, },
        };
    ...
    {
        var test = new VerifyGlobalNamespace.Test { TestState = { Sources = { ("Widget.g.cs", "// <auto-generated/>\npublic class Widget;") } }, };
