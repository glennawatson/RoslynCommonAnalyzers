...
public class UppercaseLiteralSuffixAnalyzerUnitTest
{
    ...
    [Test]
    public Task LongSuffixIsFlaggedAndFixedAsync() =>
        VerifyMemberAsync("public long M() => 1{|SST2244:l|};", "public long M() => 1L;");

    /// <summary>Verifies a lower-case unsigned suffix is reported and upper-cased.</summary>
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task UnsignedSuffixIsFlaggedAndFixedAsync() =>
        VerifyMemberAsync("public uint M() => 1{|SST2244:u|};", "public uint M() => 1U;");

    /// <summary>Verifies a lower-case float suffix is reported and upper-cased.</summary>
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task FloatSuffixIsFlaggedAndFixedAsync() =>
        VerifyMemberAsync("public float M() => 1.5{|SST2244:f|};", "public float M() => 1.5F;");

    /// <summary>Verifies a lower-case double suffix is reported and upper-cased.</summary>
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task DoubleSuffixIsFlaggedAndFixedAsync() =>
        VerifyMemberAsync("public double M() => 1{|SST2244:d|};", "public double M() => 1D;");

    /// <summary>Verifies a lower-case decimal suffix is reported and upper-cased.</summary>
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task DecimalSuffixIsFlaggedAndFixedAsync() =>
        VerifyMemberAsync("public decimal M() => 1{|SST2244:m|};", "public decimal M() => 1M;");

    /// <summary>Verifies a two-character unsigned-long suffix is reported and upper-cased as a whole.</summary>
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task UnsignedLongSuffixIsFlaggedAndFixedAsync() =>
        VerifyMemberAsync("public ulong M() => 1{|SST2244:ul|};", "public ulong M() => 1UL;");

    /// <summary>Verifies the reversed two-character suffix is reported and upper-cased as a whole.</summary>
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task LongUnsignedSuffixIsFlaggedAndFixedAsync() =>
        VerifyMemberAsync("public ulong M() => 1{|SST2244:lu|};", "public ulong M() => 1LU;");

    /// <summary>Verifies a suffix that is only half lower case is reported and fully upper-cased.</summary>
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task MixedCaseSuffixIsFlaggedAndFixedAsync() =>
        VerifyMemberAsync("public ulong M() => 1{|SST2244:Lu|};", "public ulong M() => 1LU;");
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task HexLiteralKeepsItsDigitsAsync() =>
        VerifyMemberAsync("public long M() => 0xff{|SST2244:l|};", "public long M() => 0xffL;");

    /// <summary>Verifies a binary literal's suffix is reported and upper-cased.</summary>
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task BinaryLiteralSuffixIsFlaggedAndFixedAsync() =>
        VerifyMemberAsync("public uint M() => 0b1010{|SST2244:u|};", "public uint M() => 0b1010U;");

    /// <summary>Verifies digit separators are carried through untouched.</summary>
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task DigitSeparatorsSurviveTheFixAsync() =>
        VerifyMemberAsync("public long M() => 1_000{|SST2244:l|};", "public long M() => 1_000L;");

    /// <summary>Verifies an exponent is not mistaken for part of the suffix.</summary>
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task ExponentIsNotPartOfTheSuffixAsync() =>
        VerifyMemberAsync("public float M() => 1.5e3{|SST2244:f|};", "public float M() => 1.5e3F;");

    /// <summary>Verifies an already upper-case suffix stays clean.</summary>
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task UpperCaseSuffixIsCleanAsync() =>
        VerifyMemberAsync("public ulong M() => 1UL;");

    /// <summary>Verifies a literal with no suffix at all stays clean.</summary>
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task LiteralWithoutSuffixIsCleanAsync() =>
        VerifyMemberAsync("public double M() => 1.5e3;");

    /// <summary>Verifies a hex literal's trailing 'f' digits are digits, not a float suffix.</summary>
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task HexDigitsAreNotASuffixAsync() =>
        VerifyMemberAsync("public int M() => 0xff;");

    /// <summary>Verifies a hex literal whose suffix is already upper case keeps its lower-case digits and stays clean.</summary>
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task HexWithUpperCaseSuffixIsCleanAsync() =>
        VerifyMemberAsync("public long M() => 0xffL;");

    /// <summary>Verifies a plain integer literal stays clean.</summary>
    /// <returns>A task that represents the asynchronous test operation.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [Test]
    public Task PlainIntegerIsCleanAsync() =>
        VerifyMemberAsync("public int M() => 42;");
