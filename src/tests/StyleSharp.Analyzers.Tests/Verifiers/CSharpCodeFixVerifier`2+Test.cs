    ...
    where TCodeFix : CodeFixProvider, new()
{
    ...
    public class Test : CSharpCodeFixTest<TAnalyzer, TCodeFix, DefaultVerifier>
    {
        ...
        public new async Task RunAsync(CancellationToken cancellationToken)
        {
            ...
            TestSourceLineEndings.ConvertSourcesToCrlf(BatchFixedState.Sources);
        ...
        private void PinNewline(string config)
        {
            ...
            TestSourceLineEndings.SetNestedEditorConfig(BatchFixedState.AnalyzerConfigFiles, config);
        }
    }
}
